...
import { Accessibility as h, AlertTriangle as g, ArrowDown as _, ArrowLeft as v, ArrowUp as y, BookOpen as b, Calendar as x, Check as S, CheckCircle2 as C, ChevronDown as w, ChevronLeft as T, ChevronRight as E, ChevronsUpDown as D, Columns3 as O, Eye as k, EyeOff as A, Inbox as j, Info as M, Loader2 as ee, LogOut as te, Menu as ne, Minus as re, Monitor as N, Moon as P, Palette as ie, PanelLeft as ae, PanelLeftDashed as oe, Search as se, Settings as ce, Sun as le, UploadCloud as ue, X as F, XCircle as de, Zap as fe } from "lucide-react";
...
function me({ data: e, height: t = 240 }) {
	let n = s(), r = u(null), [i, a] = d(null), o = 600 - L.left - L.right, c = t - L.top - L.bottom, l = Math.min(...e.map((e) => e.value)), h = Math.max(...e.map((e) => e.value)), g = h - l || 1;
	function _(t) {
		return L.left + t / Math.max(e.length - 1, 1) * o;
	}
	function v(e) {
		return L.top + c - (e - l) / g * c;
	}
	let y = e.map((e, t) => `${_(t)},${v(e.value)}`).join(" "), b = [
		`${_(0)},${L.top + c}`,
		...e.map((e, t) => `${_(t)},${v(e.value)}`),
		`${_(e.length - 1)},${L.top + c}`
	...
	function w(t) {
		...
		let i = n.getBoundingClientRect(), s = ((t.clientX - i.left) / i.width * 600 - L.left) / o, c = Math.round(s * (e.length - 1)), l = Math.max(0, Math.min(e.length - 1, c));
		a({
			x: _(l),
			y: v(e[l].value),
			index: l
...
var ve = new Set([
	...
	"text-left",
	"text-right"
]), xe = new Set(["lowercase", "uppercase"]), Se = new Set([
	"font-bold",
	"font-medium",
	"font-normal",
	"font-semibold"
...
function ke(e) {
	let t = Ae(e), n = t.pop() ?? e, r = n.startsWith("!"), i = je(r ? n.slice(1) : n), a = `${t.join(":")}|${r ? "!" : ""}`, o = Me(i);
...
function Ve({ segments: e, size: t = 180 }) {
	let [n, r] = d(null), i = e.reduce((e, t) => e + t.value, 0), a = (t - 28) / 2, o = Be(e, 2 * Math.PI * a), s = t + 12, c = s / 2;
	return /* @__PURE__ */ m("div", {
		...
		children: [/* @__PURE__ */ m("div", {
			...
			children: [/* @__PURE__ */ m("svg", {
				...
				children: [
					...
					o.map((e, t) => {
						...
						return /* @__PURE__ */ p("circle", {
							...
							r: a,
							fill: "none",
							stroke: ze[e.segment.color] ?? "var(--accent)",
							strokeWidth: r ? 32 : 28,
							strokeDasharray: `${e.segmentLength} ${e.dashOffset}`,
							strokeLinecap: "butt",
				...
				let e = o[n], t = e.midAngle * Math.PI / 180, r = a + 28 / 2 + 20, i = c + Math.cos(t) * r, s = c + Math.sin(t) * r, l = ze[e.segment.color] ?? "var(--accent)";
			...
			children: e.map((e, t) => /* @__PURE__ */ m("button", {
				...
				onMouseEnter: () => r(t),
				onMouseLeave: () => r(null),
				className: R("flex cursor-pointer items-center gap-1.5 transition-opacity duration-[100ms]", n !== null && n !== t && "opacity-50"),
				children: [
					/* @__PURE__ */ p("span", {
						className: "h-2 w-2 rounded-full",
						style: { backgroundColor: ze[e.color] ?? "var(--accent)" }
					}),
					/* @__PURE__ */ p("span", {
...
var He = 4;
function Ue({ data: e, maxValue: t, size: n = 240 }) {
		...
		children: [/* @__PURE__ */ m("svg", {
			...
			children: /* @__PURE__ */ m("div", {
				...
				children: [
					...
					/* @__PURE__ */ p("span", {
						className: R("text-text-secondary text-xs whitespace-nowrap"),
						children: e[r].label
					}),
					/* @__PURE__ */ p("span", {
						className: "text-text-primary text-xs font-semibold",
...
function Ge({ segments: e, size: t = 200 }) {
		...
		children: [/* @__PURE__ */ m("div", {
			...
			children: [/* @__PURE__ */ m("svg", {
				...
				children: [e.map((e, t) => {
					let i = c - t * 20;
					if (i <= 0) return null;
					let a = 2 * Math.PI * i, o = a * Math.min(e.value / e.max, 1), l = a - o, u = We[e.color] ?? "var(--accent)", d = n === t;
					return /* @__PURE__ */ m("g", {
						onMouseEnter: () => r(t),
						onMouseLeave: () => r(null),
						className: "cursor-pointer",
				...
				let t = e[n], r = Math.round(t.value / t.max * 100), a = We[t.color] ?? "var(--accent)";
				return /* @__PURE__ */ p("div", {
					className: "bg-bg-tertiary border-border pointer-events-none absolute z-10 rounded-md border px-2.5 py-1.5 shadow-lg",
					style: {
						left: i.x,
			...
			children: e.map((e, t) => {
				...
				return /* @__PURE__ */ m("button", {
					...
					children: [
						/* @__PURE__ */ p("span", {
							className: "h-2 w-2 rounded-full",
							style: { backgroundColor: We[e.color] ?? "var(--accent)" }
						}),
						/* @__PURE__ */ p("span", {
							className: "text-text-secondary text-xs",
							children: e.label
...
function Ke({ data: e, width: t = 60, height: n = 20, color: r }) {
...
function Ye({ data: e, height: t = 180 }) {
	let [n, r] = d(null), i = 600 - z.left - z.right, a = t - z.top - z.bottom, o = Math.max(...e.map((e) => e.value), 1), s = Math.max(4, (i - 6 * (e.length - 1)) / e.length);
	return /* @__PURE__ */ m("svg", {
		width: "100%",
		viewBox: `0 0 600 ${t}`,
		className: "select-none",
		children: [
			...
			e.map((e, i) => {
				let c = z.left + i * (s + 6), l = e.value / o * a, u = z.top + a - l, d = n === i;
				return /* @__PURE__ */ m("g", {
					onMouseEnter: () => r(i),
					onMouseLeave: () => r(null),
					children: [
...
function Qe({ items: e, currentPath: t, onNavigate: n, className: r }) {
	return e.length === 0 ? null : /* @__PURE__ */ p("nav", {
		className: R("bg-bg-secondary border-border font-navigation fixed right-0 bottom-0 left-0 z-30 border-t md:hidden", r),
		...
		children: /* @__PURE__ */ p("ul", {
			...
			children: e.map((e) => {
				...
				return /* @__PURE__ */ p("li", { children: /* @__PURE__ */ m("a", {
					href: e.path,
					onClick: (t) => B(t, e.path, n),
					"aria-current": r ? "page" : void 0,
					className: R("font-navigation flex h-full w-14 flex-col items-center justify-center gap-0.5", "cursor-pointer transition-colors duration-[100ms]", r ? "text-accent" : "text-text-tertiary"),
...
var $e = "a[href], button:not([disabled]), input:not([disabled]), textarea:not([disabled]), select:not([disabled]), [tabindex]:not([tabindex=\"-1\"])";
function V(e, t) {
	let n = u(null);
	o(() => {
		if (!t || !e.current) return;
		let r = e.current.ownerDocument;
		n.current = r.activeElement;
		let i = e.current.querySelectorAll($e);
		i.length > 0 && i[0].focus();
		let a = (t) => {
			if (t.key !== "Tab" || !e.current) return;
			let n = e.current.querySelectorAll($e);
			if (n.length === 0) return;
			let i = n[0], a = n[n.length - 1];
			t.shiftKey ? r.activeElement === i && (t.preventDefault(), a.focus()) : r.activeElement === a && (t.preventDefault(), i.focus());
		};
		return r.addEventListener("keydown", a), () => {
			r.removeEventListener("keydown", a), n.current instanceof HTMLElement && n.current.focus();
		};
	}, [t, e]);
}
//#endregion
//#region src/components/app-shell/commandPaletteEvents.ts
var et = "open-command-palette", tt = {
	key: "k",
	label: "⌘K",
	modifier: "primary"
};
...
function at({ items: e, eventName: t = et, shortcut: n = tt, placeholder: r = "Search pages...", emptyLabel: a = "No results found", onNavigate: c, onSelect: l }) {
	let [f, h] = d(!1), [g, _] = d(""), [v, y] = d(0), b = u(null), x = u(null), S = s();
	V(x, f);
	let C = e.filter((e) => it(e, g)), w = i(() => {
		h(!0), _(""), y(0), setTimeout(() => b.current?.focus(), 0);
	}, []);
	o(() => {
		let e = (e) => {
			rt(e, n) && (e.preventDefault(), f ? h(!1) : w());
		}, r = () => {
			f || w();
		};
	...
	return f ? /* @__PURE__ */ m("div", {
		...
		children: [/* @__PURE__ */ p("div", {
			...
			children: [/* @__PURE__ */ m("div", {
				...
				children: [
					/* @__PURE__ */ p(se, { className: "text-text-tertiary h-4 w-4 shrink-0" }),
					/* @__PURE__ */ p("input", {
						ref: b,
						type: "text",
						role: "combobox",
				...
				children: C.length === 0 ? /* @__PURE__ */ p("li", {
					...
					"aria-selected": t === v,
					onClick: () => E(e),
					className: R("flex h-9 w-full cursor-pointer items-center gap-3 rounded-md px-3 text-left", "transition-colors duration-[100ms]", t === v ? "bg-accent-muted text-accent" : "text-text-secondary hover:text-text-primary hover:bg-bg-hover"),
					children: [
						/* @__PURE__ */ p("span", {
...
function st({ open: e, onClose: t, items: n, brand: r, currentPath: i, onNavigate: a, headerActions: s, className: c }) {
	let l = u(null);
	return V(l, e), o(() => {
		if (!e) return;
		...
		let n = (e) => {
			e.key === "Escape" && t();
		}, r = l.current?.ownerDocument ?? document;
		return r.addEventListener("keydown", n), () => {
			document.body.style.overflow = "", r.removeEventListener("keydown", n);
		};
		...
		children: [/* @__PURE__ */ p("div", {
			...
			ref: l,
			className: R("bg-bg-sidebar border-border animate-slide-in-left fixed inset-y-0 left-0 z-50 flex w-64 flex-col border-r", c),
			children: [
				/* @__PURE__ */ m("div", {
					className: "border-border flex h-11 items-center justify-between border-b px-4",
					children: [/* @__PURE__ */ p(ot, { brand: r }), /* @__PURE__ */ p("button", {
						onClick: t,
						className: "text-text-tertiary hover:text-text-primary flex h-7 w-7 cursor-pointer items-center justify-center rounded",
						"aria-label": "Close menu",
						children: /* @__PURE__ */ p(F, { className: "h-4 w-4" })
					})]
				}),
				s && /* @__PURE__ */ p("div", {
				...
				/* @__PURE__ */ p("nav", {
					...
					children: /* @__PURE__ */ p("ul", {
						...
						children: n.map((e) => {
							...
							return /* @__PURE__ */ p("li", { children: /* @__PURE__ */ m("a", {
								href: e.path,
								onClick: (n) => B(n, e.path, a, t),
								"aria-current": n ? "page" : void 0,
								className: R("flex h-10 items-center gap-3 rounded-md px-3", "cursor-pointer transition-colors duration-[100ms]", n ? "bg-accent-muted text-accent" : "text-text-secondary hover:text-text-primary hover:bg-bg-hover"),
								children: [
									/* @__PURE__ */ p(e.icon, { className: "h-4 w-4" }),
									/* @__PURE__ */ p("span", {
...
var ut = ct.filter((e) => H(e.value)), dt = ct.filter((e) => !H(e.value)), ft = {
	uiFont: "inter",
	headingFont: "inter",
	proseFont: "inter",
	controlFont: "inter",
...
function G(e, t, n, r, i) {
	...
	o(() => {
		...
		return a && document.addEventListener("mousedown", i), document.addEventListener("keydown", o), () => {
			a && document.removeEventListener("mousedown", i), document.removeEventListener("keydown", o);
		};
	}, [
		e,
		t,
...
function yt({ name: e, src: t, size: n = "md", className: r }) {
	return /* @__PURE__ */ p("div", {
		className: R("text-text-on-avatar flex shrink-0 items-center justify-center rounded-full font-semibold", gt[n], r),
...
function Et({ toast: e, onDismiss: t }) {
	let [n, r] = d(100), i = Ct[e.type], a = e.type === "error" || e.type === "warning", s = u(t);
	return o(() => {
		s.current = t;
	}, [t]), o(() => {
		...
		children: [
			/* @__PURE__ */ p("div", { className: R("absolute top-1.5 bottom-1.5 left-0 w-[3px] rounded-md", wt[e.type]) }),
			/* @__PURE__ */ m("div", {
				className: "flex items-center gap-2.5 p-3 pl-3.5",
				children: [
					/* @__PURE__ */ p(i, { className: R("h-4 w-4 shrink-0", Tt[e.type]) }),
					/* @__PURE__ */ p("p", {
					...
					/* @__PURE__ */ p("button", {
						...
						children: /* @__PURE__ */ p(F, { className: "h-3 w-3" })
					})
				]
			}),
			/* @__PURE__ */ p("div", {
...
var Dt = 140, Ot = 400, kt = 48;
function At({ item: e, collapsed: t, currentPath: n, onNavigate: r }) {
	let i = Xe(e, n);
	return /* @__PURE__ */ m("a", {
		href: e.path,
		onClick: (t) => B(t, e.path, r),
		"aria-current": i ? "page" : void 0,
		className: R("font-navigation relative flex items-center gap-2 rounded px-2", "cursor-pointer transition-colors duration-[100ms]", t ? "mx-auto w-[2em] justify-center" : "", i ? "bg-accent-muted text-accent" : "text-text-secondary hover:text-text-primary hover:bg-bg-hover"),
		style: { height: "2em" },
...
function jt({ brand: e, collapsed: t }) {
	...
	return e.logo && !t ? /* @__PURE__ */ p("div", {
		...
		className: R("flex min-w-0 items-center gap-2 px-2", t && "mx-auto justify-center px-0"),
...
function Nt({ collapsed: e, accounts: t, initialAccountIndex: n = 0, onAccountChange: r, onSignOut: a, signOutPath: o, signOutLabel: s = "Sign out", onNavigate: c }) {
	...
	return C ? /* @__PURE__ */ m(f, { children: [/* @__PURE__ */ m("button", {
		ref: b,
		onClick: T,
		className: R("font-navigation flex w-full cursor-pointer items-center gap-2 rounded px-2 transition-colors duration-[100ms]", "text-text-secondary hover:text-text-primary hover:bg-bg-hover", e && "justify-center px-0"),
		style: { height: "2.5em" },
		...
		children: [
			...
			w && /* @__PURE__ */ m(f, { children: [/* @__PURE__ */ p("div", { className: "border-border my-1 border-t" }), /* @__PURE__ */ m("button", {
				...
				children: [/* @__PURE__ */ p(te, { className: "h-3.5 w-3.5" }), /* @__PURE__ */ p("span", { children: s })]
			})] })
		]
	}), document.body)] }) : null;
}
function Pt({ collapsed: e, settingsPath: t, settingsLabel: n = "All Settings", onOpenSettings: r, onNavigate: a }) {
	let [o, s] = d(!1), [c, l] = d({
		bottom: 0,
		left: 0
	}), g = u(null), _ = u(null), { accentColor: v, setAccentColor: y, reducedMotion: b, setReducedMotion: x, colorMode: C, setColorMode: w } = K(), { toast: T } = xt(), E = !!(t || r);
	G(o, i(() => s(!1), []), [_], [g]);
	function D() {
		if (!g.current) return;
	...
	return /* @__PURE__ */ m(f, { children: [/* @__PURE__ */ m("button", {
		ref: g,
		onClick: D,
		className: R("font-navigation relative flex w-full items-center gap-2 rounded px-2", "cursor-pointer transition-colors duration-[100ms]", e ? "mx-auto w-[2em] justify-center" : "", o ? "bg-accent-muted text-accent" : "text-text-secondary hover:text-text-primary hover:bg-bg-hover"),
		style: { height: "2em" },
		title: e ? "Settings" : void 0,
		children: [/* @__PURE__ */ p(ce, { className: "h-3.5 w-3.5 shrink-0" }), !e && /* @__PURE__ */ p("span", {
		...
		children: [
			...
			/* @__PURE__ */ p("div", {
				...
				children: mt.map((e) => /* @__PURE__ */ p("button", {
					onClick: () => y(e.value),
					className: R("h-5 w-5 cursor-pointer rounded-full transition-transform duration-[100ms] hover:scale-110", v === e.value && "ring-offset-bg-tertiary scale-110 ring-2 ring-offset-1"),
					style: {
			...
			E && /* @__PURE__ */ m(f, { children: [/* @__PURE__ */ p("div", { className: "border-border my-1 border-t" }), /* @__PURE__ */ m("button", {
				onClick: O,
				className: "text-text-secondary hover:text-text-primary hover:bg-bg-hover font-navigation flex h-7 w-full cursor-pointer items-center gap-2.5 px-3 text-xs transition-colors duration-[100ms]",
				children: [/* @__PURE__ */ p(ce, { className: "h-3.5 w-3.5 shrink-0" }), /* @__PURE__ */ p("span", {
					className: "flex-1 text-left",
					children: n
				})]
			})] })
...
function Ft({ navSections: e, brand: t, accounts: n = [], initialAccountIndex: r, onAccountChange: a, onSignOut: o, signOutPath: s, signOutLabel: c, settingsPath: l, settingsLabel: f, onOpenSettings: h, currentPath: g, onNavigate: _, headerActions: v, className: y }) {
	let { sidebarCollapsed: b, sidebarWidth: x, setSidebarWidth: S } = K(), [C, T] = d(/* @__PURE__ */ new Set()), E = u(null), D = u(!1), O = i((e) => {
		if (b) return;
		e.preventDefault(), D.current = !0, document.body.style.cursor = "col-resize", document.body.style.userSelect = "none";
		let t = (e) => {
			if (!D.current || !E.current) return;
			let t = E.current.getBoundingClientRect(), n = e.clientX - t.left;
			S(Math.max(Dt, Math.min(n, Ot)));
		}, n = () => {
			D.current = !1, document.body.style.cursor = "", document.body.style.userSelect = "", document.removeEventListener("mousemove", t), document.removeEventListener("mouseup", n);
		};
	...
	return /* @__PURE__ */ m("aside", {
		ref: E,
		className: R("bg-bg-secondary relative hidden shrink-0 flex-col border-r md:flex", "transition-[width] duration-[200ms] ease-out", "border-border", y),
		style: { width: b ? kt : x },
		children: [
			!b && /* @__PURE__ */ p("div", {
				onMouseDown: O,
			...
			!b && v && /* @__PURE__ */ p("div", {
				className: "border-border shrink-0 border-b px-2 py-2",
				children: v
			}),
			/* @__PURE__ */ p("nav", {
				...
				children: e.map((e, t) => {
					...
					return /* @__PURE__ */ m("div", {
						className: "mb-4",
						children: [b ? t > 0 && /* @__PURE__ */ p("hr", { className: "border-border mx-auto my-1.5 w-4/5" }) : /* @__PURE__ */ m("button", {
							onClick: () => k(e.title),
							className: "text-2xs-f text-text-tertiary hover:text-text-secondary font-label flex w-full cursor-pointer items-center gap-1 px-2 text-left font-semibold tracking-wider uppercase",
							style: {
								paddingTop: "0.35em",
							...
							children: [/* @__PURE__ */ p("span", {
								...
								children: e.title
							}), /* @__PURE__ */ p(w, { className: R("h-3 w-3 shrink-0 transition-transform", n && "-rotate-90") })]
						}), (!n || b) && /* @__PURE__ */ p("ul", {
							className: "flex flex-col gap-1",
							children: e.items.map((e) => /* @__PURE__ */ p("li", { children: /* @__PURE__ */ p(At, {
								item: e,
								collapsed: b,
								currentPath: g,
								onNavigate: _
...
function Lt({ homeLabel: e = "Dashboard", labels: t = {}, parents: n = {}, currentPath: r = "/", onNavigate: i, className: a }) {
	...
	return /* @__PURE__ */ p("nav", {
		...
		className: R("font-navigation flex items-center gap-1 text-xs", a),
		children: s.map((e, t) => {
			let n = t === s.length - 1;
			return /* @__PURE__ */ m("span", {
				...
				children: [t > 0 && /* @__PURE__ */ p(E, { className: "text-text-tertiary h-3 w-3" }), n ? /* @__PURE__ */ p("span", {
					...
					href: e.path,
					onClick: (t) => B(t, e.path, i),
					className: R("text-text-tertiary hover:text-text-primary cursor-pointer transition-colors duration-[100ms]"),
					children: e.label
				})]
			}, e.path);
		})
...
}, q = r(({ variant: e = "secondary", size: t = "md", loading: n, icon: r, hideLabel: i, className: a, children: o, disabled: s, ...c }, l) => {
	let u = e === "icon", d = i === !0 ? "sm" : i === !1 ? void 0 : i;
	return /* @__PURE__ */ m("button", {
		ref: l,
		disabled: s || n,
		className: R("inline-flex items-center justify-center rounded-md font-medium", "font-control", "transition-colors duration-[100ms] ease-out", "cursor-pointer", "disabled:cursor-not-allowed disabled:opacity-40", "focus-visible:outline-accent focus-visible:outline-2 focus-visible:outline-offset-2", zt[e], u ? Vt[t] : Bt[t], d && !u && Wt[d]?.[t], a),
		...c,
		children: [
			n && /* @__PURE__ */ p(ee, { className: "h-3.5 w-3.5 animate-spin" }),
			r && !n && /* @__PURE__ */ p(r, { className: Ht[t] }),
			o && (d ? /* @__PURE__ */ p("span", {
				className: Ut[d],
				children: o
			}) : o)
...
function J({ children: e, as: t = "h2", className: n, border: r = !0 }) {
	return /* @__PURE__ */ p(t, {
		className: R("text-text-primary font-heading text-xs font-semibold", r && "border-border border-b pb-2", n),
		children: e
	});
}
//#endregion
...
function Y({ options: e, value: t, onChange: n, label: r, placeholder: a = "Select...", className: o, size: c = "md" }) {
	let [l, f] = d(!1), [h, g] = d(-1), _ = u(null), v = u(null), y = Gt(l, _, v), b = s(), x = `${b}-listbox`, C = e.find((e) => e.value === t);
	G(l, i(() => f(!1), []), [_]);
	function T() {
		if (!l) {
		...
		children: [r && /* @__PURE__ */ p("span", {
			...
			children: [
				/* @__PURE__ */ p("button", {
					...
					className: R("font-control flex w-full cursor-pointer items-center rounded-md text-xs", "bg-bg-secondary border-border text-text-primary border", "hover:bg-bg-hover hover:border-border-strong", "transition-colors duration-[100ms]", "focus-visible:outline-accent focus-visible:outline-2 focus-visible:outline-offset-2", c === "sm" ? "h-6 px-2 pr-6" : "h-7 px-2 pr-7"),
					children: C ? C.label : /* @__PURE__ */ p("span", {
						className: "text-text-disabled",
						children: a
					})
				}),
				/* @__PURE__ */ p(w, { className: R("text-text-tertiary pointer-events-none absolute top-1/2 h-3 w-3 -translate-y-1/2 transition-transform", c === "sm" ? "right-1.5" : "right-2", l && "rotate-180") }),
				l && /* @__PURE__ */ p("div", {
					ref: v,
					className: R("bg-bg-tertiary border-border-strong animate-scale-in absolute right-0 left-0 z-[100] overflow-hidden rounded-md border shadow-lg", y ? "bottom-full mb-1" : "top-full mt-1"),
					children: /* @__PURE__ */ p("ul", {
						id: x,
						...
						children: e.map((e, r) => /* @__PURE__ */ m("li", {
							...
							onMouseEnter: () => g(r),
							className: R("font-control flex h-7 w-full cursor-pointer items-center gap-2 px-3 text-xs", "transition-colors duration-[100ms]", r === h ? "bg-accent-muted text-accent" : e.value === t ? "text-accent" : "text-text-secondary hover:text-text-primary hover:bg-bg-hover"),
							children: [/* @__PURE__ */ p("span", {
...
function X({ min: e, max: t, step: n = 1, value: r, onChange: i, onCommit: a, label: o, showValue: s, className: c }) {
	let l = (r - e) / (t - e) * 100;
	return /* @__PURE__ */ m("div", {
		className: R("flex flex-col gap-1.5", c),
...
function Kt({ label: e, active: t, icon: n, preview: r, onClick: i, className: a }) {
	return /* @__PURE__ */ m("button", {
		type: "button",
		onClick: i,
		className: R("flex cursor-pointer flex-col items-center gap-2 rounded-md border p-3 transition-colors duration-[100ms]", t ? "border-accent bg-accent-muted" : "border-border bg-bg-secondary hover:bg-bg-hover hover:border-border-strong", a),
		children: [/* @__PURE__ */ p("div", {
...
function qt({ checked: e, onChange: t, disabled: n, label: r, className: i }) {
	return /* @__PURE__ */ m("label", {
		className: R("flex w-fit items-center", n ? "cursor-not-allowed opacity-40" : "cursor-pointer", i),
		style: { gap: 10 },
		children: [/* @__PURE__ */ p("button", {
			...
			disabled: n,
			onClick: () => t(!e),
			className: R("relative shrink-0 rounded-full border transition-colors duration-[100ms]", "focus-visible:outline-accent focus-visible:outline-2 focus-visible:outline-offset-2", e ? "bg-accent border-accent" : "bg-bg-tertiary border-border", !n && "cursor-pointer"),
			style: {
				width: 36,
				height: 20
			},
...
//#endregion
//#region src/components/app-shell/themeMenuEvents.ts
var Jt = "open-theme-menu";
function Yt(e = Jt) {
	typeof document > "u" || document.dispatchEvent(new CustomEvent(e));
}
//#endregion
//#region src/components/app-shell/ThemeMenu.tsx
var Xt = [
	{
		value: "dark",
		label: "Dark",
...
function Zt({ className: e, respondToOpenEvent: t = !0 }) {
	let [n, r] = d(!1), [a, s] = d(!1), [c, l] = d({
		top: 0,
		right: 0
	}), h = u(null), g = u(null), _ = K(), v = Rt(), { toast: y } = xt(), b = i(() => {
		r(!1), s(!1);
	}, []);
	G(n, b, [g], [h], { outsideClick: !a });
	let x = i(() => {
		if (!h.current) return;
	...
	o(() => {
		...
		return document.addEventListener(Jt, e), () => document.removeEventListener(Jt, e);
	}, [t, x]), o(() => {
		if (n) return window.addEventListener("resize", x), window.addEventListener("scroll", x, !0), () => {
			window.removeEventListener("resize", x), window.removeEventListener("scroll", x, !0);
		};
	}, [n, x]);
	let { colorMode: C, setColorMode: w, preferredDarkTheme: T, preferredLightTheme: E, accentColor: D, setAccentColor: O, fontSize: k, setFontSize: A, uiFont: j, setUiFont: M, headingFont: ee, setHeadingFont: te, proseFont: ne, setProseFont: re, codeFont: N, setCodeFont: P, borderRadius: ae, setBorderRadius: oe, borderWidth: se, setBorderWidth: ce, tracking: le, setTracking: ue, lineHeight: F, setLineHeight: de, density: fe, setDensity: L, reducedMotion: pe, setReducedMotion: me, saveThemeCustomization: he, resetThemeCustomization: ge, hasThemeOverrides: _e, isCustomized: ve, resolvedTheme: ye } = _;
	return /* @__PURE__ */ m(f, { children: [/* @__PURE__ */ p("button", {
		...
		"aria-expanded": n,
		title: "Theme",
		className: R("flex h-7 w-7 cursor-pointer items-center justify-center rounded transition-colors duration-[100ms]", n ? "text-accent bg-accent-muted" : "text-text-tertiary hover:text-text-primary hover:bg-bg-hover", e),
		children: /* @__PURE__ */ p(ie, { className: "h-4 w-4" })
	}), n && I(/* @__PURE__ */ p("div", {
		ref: g,
		role: "dialog",
		"aria-label": "Theme settings",
		className: "bg-bg-tertiary border-border-strong animate-scale-in fixed z-[100] flex w-80 flex-col overflow-y-auto rounded-md border p-3 shadow-lg",
		style: {
			top: c.top,
			right: c.right,
			maxHeight: "80vh"
		...
		children: /* @__PURE__ */ m("div", {
			className: "space-y-4",
			children: [
				/* @__PURE__ */ m("div", { children: [/* @__PURE__ */ p(J, {
					as: "h3",
					border: !1,
					className: "mb-2",
					children: "Mode"
				}), /* @__PURE__ */ p("div", {
					className: "bg-bg-secondary border-border flex gap-1 rounded-md border p-1.5",
					children: Xt.map(({ value: e, label: t, Icon: n }) => /* @__PURE__ */ m("button", {
						onClick: () => w(e),
						className: R("font-navigation flex flex-1 cursor-pointer items-center justify-center gap-1.5 rounded px-2 py-1 text-xs transition-colors duration-[100ms]", C === e ? "bg-accent-muted text-accent" : "text-text-secondary hover:text-text-primary hover:bg-bg-hover"),
						children: [/* @__PURE__ */ p(n, { className: "h-3.5 w-3.5" }), t]
					}, e))
				})] }),
				/* @__PURE__ */ m("div", { children: [/* @__PURE__ */ p(J, {
					as: "h3",
					border: !1,
					className: "mb-2",
					children: "Dark themes"
				}), /* @__PURE__ */ p("div", {
					className: "grid grid-cols-2 gap-2",
					children: dt.map((e) => /* @__PURE__ */ p(Kt, {
						label: e.label,
						icon: e.icon,
						preview: e.preview,
						active: T === e.value,
				...
				/* @__PURE__ */ m("div", { children: [/* @__PURE__ */ p(J, {
					...
					border: !1,
					className: "mb-2",
					children: "Light themes"
				}), /* @__PURE__ */ p("div", {
					className: "grid grid-cols-2 gap-2",
					children: ut.map((e) => /* @__PURE__ */ p(Kt, {
						label: e.label,
						icon: e.icon,
						preview: e.preview,
						active: E === e.value,
				...
				/* @__PURE__ */ m("div", { children: [/* @__PURE__ */ p(J, {
					...
					children: mt.map((e) => /* @__PURE__ */ p("button", {
						onClick: () => O(e.value),
						className: R("h-6 w-6 cursor-pointer rounded-full transition-transform duration-[100ms] hover:scale-110", D === e.value && "ring-offset-bg-tertiary scale-110 ring-2 ring-offset-1"),
						style: {
							backgroundColor: e.color,
							...D === e.value ? { "--utility-ring-color": e.color } : {}
						},
						title: e.value.charAt(0).toUpperCase() + e.value.slice(1),
						"aria-label": e.value
					}, e.value))
				...
				/* @__PURE__ */ m("div", {
					...
					children: [/* @__PURE__ */ p(q, {
						...
						disabled: !ve,
						onClick: () => {
							he(), y("success", `Saved customization for ${ct.find((e) => e.value === ye)?.label ?? ye}`);
						},
						children: "Save for theme"
					}), /* @__PURE__ */ p(q, {
						variant: "secondary",
						size: "sm",
						disabled: !_e && !ve,
						onClick: () => {
							ge(), y("info", "Reset to theme defaults");
						},
						children: "Reset"
					})]
				})
...
function tn({ onMobileMenuToggle: e, breadcrumbs: t, showCommandTrigger: n = !0, commandTriggerLabel: r = "Search", commandShortcut: i = tt, currentPath: a, onNavigate: o, onCommandTrigger: s, actions: c }) {
	let { sidebarCollapsed: l, setSidebarCollapsed: u, colorMode: d, setColorMode: h } = K();
	function g() {
		h(Qt[(Qt.indexOf(d) + 1) % Qt.length]);
	}
	let _ = $t[d];
		...
		children: [/* @__PURE__ */ m("div", {
			...
			children: [
				/* @__PURE__ */ p("button", {
					...
					children: /* @__PURE__ */ p(ne, { className: "h-4 w-4" })
				}),
				/* @__PURE__ */ p("button", {
					onClick: () => u(!l),
					...
					children: p(l ? oe : ae, { className: "h-4 w-4" })
				}),
				t !== !1 && /* @__PURE__ */ m(f, { children: [/* @__PURE__ */ p("div", { className: "bg-border hidden h-4 w-px md:block" }), /* @__PURE__ */ p(Lt, {
					...t,
					currentPath: a,
					onNavigate: o
				})] })
			...
			children: [
				...
				n && /* @__PURE__ */ m("button", {
					...
					children: [
						/* @__PURE__ */ p(se, { className: "h-3 w-3" }),
						/* @__PURE__ */ p("span", {
							className: "text-2xs",
							children: r
						}),
				...
				/* @__PURE__ */ p("button", {
					...
					"aria-label": `Color mode: ${en[d]}. Click to cycle.`,
					title: en[d],
					children: /* @__PURE__ */ p(_, { className: "h-4 w-4" })
				}),
				/* @__PURE__ */ p(Zt, {})
			]
		})]
...
function nn({ children: e, navSections: t, brand: n, accounts: r, bottomNavItems: i = [], commandItems: a, breadcrumbs: o, initialAccountIndex: s, onAccountChange: c, onSignOut: u, signOutPath: f, signOutLabel: h, settingsPath: g, settingsLabel: _, onOpenSettings: v, showCommandPalette: y = !0, showCommandTrigger: b = !0, commandTriggerLabel: x, commandShortcut: S, sidebarHeaderActions: C, topBarActions: w, currentPath: T, onNavigate: E, mainClassName: D, className: O }) {
	let [k, A] = d(!1), j = l(() => t.flatMap((e) => e.items), [t]), M = a ?? j;
	return /* @__PURE__ */ m("div", {
		className: R("bg-bg-primary flex h-svh overflow-hidden", O),
		children: [
			/* @__PURE__ */ p("a", {
				href: "#main-content",
				className: "skip-link",
			...
			/* @__PURE__ */ m("div", {
				...
				children: [/* @__PURE__ */ p(tn, {
					...
					id: "main-content",
					className: R("flex-1 overflow-y-auto p-4 pb-20 md:p-6 md:pb-6", D),
					children: e
				})]
			}),
			/* @__PURE__ */ p(Qe, {
...
function rn({ children: e, className: t }) {
	return /* @__PURE__ */ m("div", {
		className: R("bg-bg-primary relative flex min-h-svh items-center justify-center p-4", t),
		children: [/* @__PURE__ */ p("div", {
...
function an({ to: e, children: t, onNavigate: n, className: r }) {
	return /* @__PURE__ */ m("a", {
		href: e,
		onClick: (t) => B(t, e, n),
		className: R("inline-flex items-center gap-1.5", "text-text-tertiary text-xs", "hover:text-text-primary", r),
		children: [/* @__PURE__ */ p(v, { className: "h-3.5 w-3.5" }), t]
	});
}
//#endregion
//#region src/components/ui/Checkbox.tsx
function on({ checked: e, indeterminate: t, onChange: n, label: r, disabled: i, className: a }) {
	let o = e || t;
	return /* @__PURE__ */ m("label", {
		className: R("flex w-fit items-center gap-2.5", i ? "cursor-not-allowed opacity-40" : "cursor-pointer", a),
		children: [/* @__PURE__ */ p("button", {
			role: "checkbox",
			"aria-checked": t ? "mixed" : e,
			disabled: i,
			onClick: () => n(!e),
			className: R("flex h-4 w-4 shrink-0 items-center justify-center rounded border", "transition-colors duration-[100ms]", "focus-visible:outline-accent focus-visible:outline-2 focus-visible:outline-offset-2", o ? "bg-accent border-accent" : "bg-bg-secondary border-border", !i && "cursor-pointer"),
			children: t ? /* @__PURE__ */ p(re, { className: "text-text-on-accent h-3 w-3" }) : e ? /* @__PURE__ */ p(S, { className: "text-text-on-accent h-3 w-3" }) : null
		}), r && /* @__PURE__ */ p("span", {
...
var sn = r(function({ icon: e, children: t, className: n, ...r }, i) {
	return /* @__PURE__ */ m("button", {
		ref: i,
		className: R("flex h-7 cursor-pointer items-center gap-1.5 rounded-md px-2.5", "border-border bg-bg-secondary text-text-secondary border", "hover:bg-bg-hover hover:border-border-strong", "text-xs", "transition-colors duration-[100ms]", n),
		...r,
...
function cn({ columns: e, hidden: t, onToggle: n }) {
	let [r, a] = d(!1), o = u(null);
	return G(r, i(() => a(!1), []), [o]), /* @__PURE__ */ m("div", {
		className: "relative",
		ref: o,
...
function ln({ page: e, totalPages: t, onPageChange: n }) {
	if (t <= 1) return null;
	let r = [];
	...
	return /* @__PURE__ */ m("div", {
		...
		children: [
			...
			r.map((t, r) => t === "ellipsis" ? /* @__PURE__ */ p("span", {
				...
				onClick: () => n(t),
				className: R("flex h-7 w-7 cursor-pointer items-center justify-center rounded text-xs font-medium", "transition-colors duration-[100ms]", t === e ? "bg-accent text-text-on-accent" : "text-text-secondary hover:text-text-primary hover:bg-bg-hover"),
				children: t
			}, t)),
			/* @__PURE__ */ p("button", {
				disabled: e === t,
...
function dn({ data: e, columns: t, getRowId: n, onRowClick: r, emptyMessage: i = "No data", sortKey: a, sortDir: o, onSortChange: s }) {
	let c = s !== void 0, [u, f] = d(null), [h, g] = d("asc"), v = c ? a ?? null : u, b = c ? o ?? "asc" : h, x = l(() => c ? e : un(e, t, v, b), [
		c,
		e,
		t,
		v,
		...
		children: /* @__PURE__ */ m("table", {
			...
			children: [/* @__PURE__ */ p("thead", { children: /* @__PURE__ */ p("tr", {
				...
				children: t.map((e) => /* @__PURE__ */ p("th", {
					className: R("text-2xs text-text-tertiary font-label h-7 px-3 text-left font-semibold tracking-wider uppercase", e.sortable && "hover:text-text-secondary cursor-pointer select-none"),
					style: { width: e.width },
				...
				className: R("border-border h-8 border-b last:border-b-0", "hover:bg-bg-hover", r && "cursor-pointer"),
				onClick: r ? () => r(e) : void 0,
				children: t.map((t) => /* @__PURE__ */ p("td", {
					className: R("text-text-primary px-3 whitespace-nowrap", t.cellClassName),
...
function pn({ type: e, title: t, children: n, dismissible: r, className: i }) {
	let [a, o] = d(!1);
	if (a) return null;
	let s = fn[e], c = s.icon;
	return /* @__PURE__ */ m("div", {
		className: R("flex gap-2.5 rounded-md border p-3", s.bg, s.border, i),
		children: [
			/* @__PURE__ */ p(c, { className: R("mt-0.5 h-4 w-4 shrink-0", s.iconColor) }),
			/* @__PURE__ */ m("div", {
				className: "min-w-0 flex-1",
...
function mn({ title: e, subtitle: t, icon: n, children: r, footer: i, className: a }) {
	return /* @__PURE__ */ p("div", {
		className: R("relative z-10 w-full max-w-sm", a),
		children: /* @__PURE__ */ m("div", {
...
function hn({ name: e, meta: t, nameAppend: n, size: r = "sm", className: i }) {
	return /* @__PURE__ */ m("div", {
		className: R("flex items-center gap-2", i),
		children: [/* @__PURE__ */ p(yt, {
			name: e,
			size: "sm"
		}), /* @__PURE__ */ m("div", { children: [/* @__PURE__ */ m("p", {
			className: R("text-text-primary font-label font-medium", r === "md" ? "text-xs" : "text-2xs"),
			children: [e, n]
		}), t && /* @__PURE__ */ p("p", {
...
function vn({ color: e = "gray", dot: t, children: n, className: r }) {
	return /* @__PURE__ */ m("span", {
		className: R("font-label text-2xs inline-flex items-center gap-1.5 rounded-md px-2 py-0.5 font-medium", gn[e], r),
		children: [t && /* @__PURE__ */ p("span", { className: R("h-1.5 w-1.5 rounded-full", _n[e]) }), n]
	});
}
//#endregion
...
function Tn({ year: e, month: t, selected: n, rangeStart: r, rangeEnd: i, hoverDate: a, onSelect: o, onMonthChange: s, onHover: c, minDate: l, maxDate: f }) {
	let h = Cn(e, t), g = wn(e, t), _ = /* @__PURE__ */ new Date(), v = u(null), [y, b] = d(null);
	function x() {
	...
	return /* @__PURE__ */ m("div", {
		...
		children: [/* @__PURE__ */ m("div", {
			...
			children: [yn.map((e) => /* @__PURE__ */ p("div", {
				...
				let d = new Date(e, t, s), m = xn(d, _), h = n ? xn(d, n) : !1, g = r ? xn(d, r) : !1, v = i ? xn(d, i) : !1, y = Sn(d, r ?? null, i ?? a ?? null), b = l && d < l || f && d > f;
				return /* @__PURE__ */ p("button", {
					...
					onMouseEnter: () => c?.(d),
					onMouseLeave: () => c?.(null),
					className: R("flex h-8 w-full cursor-pointer items-center justify-center text-xs transition-colors duration-[100ms]", "rounded-md", b && "cursor-not-allowed opacity-30", !b && !h && !g && !v && !y && "hover:bg-bg-hover text-text-primary", m && !h && !g && !v && "text-accent font-semibold", (h || g || v) && "bg-accent text-text-on-accent font-semibold", y && !h && !g && !v && "bg-accent-muted text-accent"),
					children: s
				}, s);
			})]
		})]
...
function En({ children: e, className: t, header: n, footer: r }) {
	return /* @__PURE__ */ m("div", {
		className: R("bg-bg-secondary border-border overflow-hidden rounded-md border", t),
		children: [
			n && /* @__PURE__ */ p("div", {
...
function Dn({ options: e, value: t, onChange: n, placeholder: r = "Select...", label: a, className: o }) {
		...
		children: [a && /* @__PURE__ */ p("span", {
			...
			children: [
				/* @__PURE__ */ p("button", {
					type: "button",
					onClick: () => c ? l(!1) : D(),
					className: R("font-control flex h-7 w-full cursor-pointer items-center rounded-md px-2 pr-7 text-xs", "bg-bg-secondary border-border text-text-primary border", "hover:bg-bg-hover hover:border-border-strong", "transition-colors duration-[100ms]", "focus-visible:outline-accent focus-visible:outline-2 focus-visible:outline-offset-2"),
					children: x ? x.label : /* @__PURE__ */ p("span", {
						className: "text-text-disabled",
						children: r
					})
				}),
				/* @__PURE__ */ p(w, { className: R("text-text-tertiary pointer-events-none absolute top-1/2 right-2.5 h-3.5 w-3.5 -translate-y-1/2 transition-transform", c && "rotate-180") }),
				c && /* @__PURE__ */ m("div", {
					...
					children: [/* @__PURE__ */ p("div", {
						...
						children: /* @__PURE__ */ m("div", {
							className: "relative",
							children: [/* @__PURE__ */ p(se, { className: "text-text-tertiary absolute top-1/2 left-2 h-3 w-3 -translate-y-1/2" }), /* @__PURE__ */ p("input", {
								ref: y,
								type: "text",
						...
						children: C.length === 0 ? /* @__PURE__ */ p("li", {
							...
							onMouseEnter: () => _(r),
							className: R("font-control flex h-7 w-full cursor-pointer items-center gap-2 px-3 text-xs", "transition-colors duration-[100ms]", r === g ? "bg-accent-muted text-accent" : e.value === t ? "text-accent" : "text-text-secondary hover:text-text-primary hover:bg-bg-hover"),
							children: [/* @__PURE__ */ p("span", {
								className: "flex-1 truncate",
								children: e.label
							}), e.value === t && /* @__PURE__ */ p(S, { className: "h-3 w-3 shrink-0" })]
...
function On({ title: e = "Danger Zone", description: t, children: n, className: r }) {
	return /* @__PURE__ */ m("div", {
		className: R("border-border mt-8 border-t pt-6", r),
		children: [
			/* @__PURE__ */ p("h3", {
...
function An({ label: e, value: t, onChange: n, placeholder: r = "Select date...", format: a = kn }) {
	let [o, s] = d(!1), c = u(null), l = u(null), f = Gt(o, c, l), h = /* @__PURE__ */ new Date(), [g, _] = d(t?.getFullYear() ?? h.getFullYear()), [v, y] = d(t?.getMonth() ?? h.getMonth());
	G(o, i(() => s(!1), []), [c]);
	function b(e) {
		n(e), s(!1);
	}
		...
		children: [e && /* @__PURE__ */ p("span", {
			...
			children: [
				/* @__PURE__ */ p("button", {
					...
					"aria-haspopup": "dialog",
					"aria-expanded": o,
					className: R("flex h-7 w-full cursor-pointer items-center rounded-md text-xs", "bg-bg-secondary border-border text-text-primary border", "hover:bg-bg-hover hover:border-border-strong", "transition-colors duration-[100ms]", "px-2 pr-7"),
				...
				o && /* @__PURE__ */ p("div", {
					...
					className: R("bg-bg-tertiary border-border-strong animate-scale-in absolute left-0 z-[100] rounded-md border p-3 shadow-lg", f ? "bottom-full mb-1" : "top-full mt-1"),
					children: /* @__PURE__ */ p(Tn, {
						year: g,
						month: v,
						selected: t,
...
function Mn(e) {
	return `${jn[e.getMonth()]} ${e.getDate()}, ${e.getFullYear()}`;
}
function Nn(e) {
	return e.start && e.end ? `${Mn(e.start)} – ${Mn(e.end)}` : e.start ? Mn(e.start) : "";
}
function Pn({ label: e, value: t, onChange: n, placeholder: r = "Select date range..." }) {
	let [a, o] = d(!1), s = u(null), c = u(null), l = Gt(a, s, c), f = /* @__PURE__ */ new Date(), [h, g] = d(t.start?.getFullYear() ?? f.getFullYear()), [_, v] = d(t.start?.getMonth() ?? f.getMonth()), [y, b] = d(null), [S, C] = d("start"), [w, T] = d(t.start), [E, D] = d(t.end);
	G(a, i(() => o(!1), []), [s]);
		...
		children: [e && /* @__PURE__ */ p("span", {
			...
			children: [
				...
				a && /* @__PURE__ */ m("div", {
					...
					className: R("bg-bg-tertiary border-border-strong animate-scale-in absolute left-0 z-[100] rounded-md border p-3 shadow-lg", l ? "bottom-full mb-1" : "top-full mt-1"),
					children: [/* @__PURE__ */ m("div", {
						className: "mb-2 flex items-center justify-between",
						children: [
							/* @__PURE__ */ p("button", {
...
function Rn(e) {
	let t = Fn[e.getMonth()], n = e.getDate(), r = e.getFullYear(), { hour12: i, period: a } = In(e.getHours());
	return `${t} ${n}, ${r} ${i}:${String(e.getMinutes()).padStart(2, "0")} ${a}`;
}
function zn(e) {
	return String(e).padStart(2, "0");
}
function Bn({ label: e, value: t, onChange: n, placeholder: r = "Select date & time..." }) {
	let [a, o] = d(!1), s = u(null), c = u(null), l = Gt(a, s, c), f = /* @__PURE__ */ new Date(), h = t ? In(t.getHours()) : {
		hour12: 12,
		period: "PM"
	}, [g, _] = d(t?.getFullYear() ?? f.getFullYear()), [v, y] = d(t?.getMonth() ?? f.getMonth()), [b, S] = d(String(h.hour12)), [C, w] = d(t ? zn(t.getMinutes()) : "00"), [T, E] = d(h.period), [D, O] = d(t);
	G(a, i(() => o(!1), []), [s]);
	function k(e) {
		O(e);
	}
	...
	function j() {
		if (!D) return;
		let e = Math.max(1, Math.min(12, parseInt(b, 10) || 12)), t = Math.max(0, Math.min(59, parseInt(C, 10) || 0)), r = Ln(e, T);
	...
	function M() {
		if (!a && t) {
			...
			let e = In(t.getHours());
			S(String(e.hour12)), E(e.period), w(zn(t.getMinutes()));
		}
		o(!a);
	}
	return /* @__PURE__ */ m("div", {
		...
		children: [e && /* @__PURE__ */ p("span", {
			...
			children: [
				/* @__PURE__ */ p("button", {
					...
					"aria-expanded": a,
					className: R("flex h-7 w-full cursor-pointer items-center rounded-md text-xs", "bg-bg-secondary border-border text-text-primary border", "hover:bg-bg-hover hover:border-border-strong", "transition-colors duration-[100ms]", "px-2 pr-7"),
					children: t ? Rn(t) : /* @__PURE__ */ p("span", {
						className: "text-text-disabled",
						children: r
					})
				}),
						...
						children: [
							...
							/* @__PURE__ */ m("div", {
								...
								children: [/* @__PURE__ */ p("button", {
									...
									onClick: () => E("AM"),
									"aria-pressed": T === "AM",
									className: R("text-2xs cursor-pointer px-2 py-0.5 font-medium transition-colors duration-[100ms]", T === "AM" ? "bg-accent text-text-on-accent" : "bg-bg-secondary text-text-secondary hover:bg-bg-hover"),
									children: "AM"
								}), /* @__PURE__ */ p("button", {
									type: "button",
									onClick: () => E("PM"),
									"aria-pressed": T === "PM",
									className: R("text-2xs cursor-pointer px-2 py-0.5 font-medium transition-colors duration-[100ms]", T === "PM" ? "bg-accent text-text-on-accent" : "bg-bg-secondary text-text-secondary hover:bg-bg-hover"),
									children: "PM"
								})]
							}),
							/* @__PURE__ */ p("button", {
								...
								onClick: j,
								disabled: !D,
								className: R("ml-auto h-6 rounded-md px-3 text-xs font-medium transition-colors duration-[100ms]", D ? "bg-accent text-text-on-accent hover:bg-accent-hover cursor-pointer" : "bg-bg-hover text-text-disabled cursor-not-allowed"),
								children: "Apply"
							})
						]
					})]
...
var Vn = 360, Hn = 260, Un = 700;
function Wn({ open: e, onClose: t, title: n, children: r, className: a, resizable: s = !0, defaultWidth: c = Vn, minWidth: l = Hn, maxWidth: f = Un }) {
	...
	return /* @__PURE__ */ p("div", {
		className: R("border-border bg-bg-secondary relative shrink-0 overflow-hidden border-l", "transition-[width] duration-[200ms] ease-out", a),
		style: { width: e ? h : 0 },
			...
			children: [
				...
				/* @__PURE__ */ m("div", {
					...
					children: [/* @__PURE__ */ p("h3", {
						...
						children: /* @__PURE__ */ p(F, { className: "h-3.5 w-3.5" })
					})]
				}),
				/* @__PURE__ */ p("div", {
...
function Gn({ open: e, onClose: t, title: n, children: r, footer: i, className: a }) {
	let c = u(null), l = s();
	return V(c, e), o(() => {
		if (!e) return;
		let n = (e) => {
		...
		children: [/* @__PURE__ */ p("div", {
			...
			ref: c,
			className: R("relative z-50 mx-4 mb-8 w-full max-w-[400px] p-6", "bg-bg-secondary border-border rounded-lg border", "animate-scale-in shadow-lg", a),
			role: "dialog",
			"aria-modal": "true",
...
function Kn({ onCancel: e, onConfirm: t, cancelLabel: n = "Cancel", confirmLabel: r = "Confirm", confirmVariant: i = "primary", className: a }) {
	return /* @__PURE__ */ m("div", {
		className: R("flex justify-end gap-2", a),
		children: [/* @__PURE__ */ p(q, {
			variant: "ghost",
			size: "sm",
			onClick: e,
...
function qn({ children: e, className: t }) {
	return /* @__PURE__ */ m("div", {
		className: R("relative my-6", t),
		children: [/* @__PURE__ */ p("div", {
...
function Jn({ trigger: e, items: t, align: n = "right" }) {
	let [r, a] = d(!1), [s, c] = d({
		top: 0,
		left: 0,
		triggerWidth: 0
	...
	return /* @__PURE__ */ m(f, { children: [/* @__PURE__ */ p("div", {
		...
		children: t.map((e, t) => {
			...
			return /* @__PURE__ */ m("button", {
				...
				onMouseEnter: () => g(n),
				className: R("flex h-7 w-full cursor-pointer items-center gap-2 px-4 text-left text-xs", "transition-colors duration-[100ms]", "focus:outline-none", e.danger ? "text-red hover:bg-red-muted focus:bg-red-muted" : "text-text-secondary hover:text-text-primary hover:bg-bg-hover focus:text-text-primary focus:bg-bg-hover"),
				children: [
...
function Yn({ icon: e, title: t, description: n, action: r, className: i }) {
	return /* @__PURE__ */ m("div", {
		className: R("flex flex-col items-center justify-center px-4 py-12", i),
		children: [
			/* @__PURE__ */ p("div", {
				className: "bg-bg-tertiary text-text-tertiary mb-3 flex h-10 w-10 items-center justify-center rounded-md",
				children: e || /* @__PURE__ */ p(j, { className: "h-5 w-5" })
			}),
			/* @__PURE__ */ p("p", {
...
function Zn({ icon: e, children: t, items: n, align: r, className: i }) {
	return /* @__PURE__ */ p(Jn, {
		align: r,
		trigger: /* @__PURE__ */ p(sn, {
			icon: e,
			className: i,
			children: t
		}),
...
function Qn({ children: e, className: t }) {
	return /* @__PURE__ */ p("kbd", {
		className: R("text-2xs inline-flex items-center px-1.5 py-0.5 font-mono font-medium", "bg-bg-tertiary text-text-secondary border-border rounded border", t),
		children: e
	});
}
//#endregion
...
function er({ className: e, size: t = "md" }) {
	return /* @__PURE__ */ p("div", {
		className: R("flex min-h-[200px] items-center justify-center", e),
		children: /* @__PURE__ */ p(ee, { className: R("text-accent animate-spin", $n[t]) })
	});
}
//#endregion
//#region src/components/ui/MetadataGrid.tsx
function tr({ items: e, labelWidth: n = "100px", className: r }) {
	return /* @__PURE__ */ p("div", {
		className: R("gap-x-3 gap-y-2 text-xs", r),
		style: {
			display: "grid",
...
function nr({ label: e, value: t, sub: n, bar: r, icon: i, iconColor: a, className: o }) {
	return /* @__PURE__ */ m("div", {
		className: R("bg-bg-secondary border-border relative overflow-hidden rounded-md border p-3", o),
		children: [
			i && /* @__PURE__ */ p(i, { className: R("absolute -right-9 -bottom-9 h-44 w-44 -rotate-45 opacity-[0.06]", a) }),
			/* @__PURE__ */ p("p", {
...
function sr({ provider: e, children: t, ...n }) {
	let r = or[e];
	return /* @__PURE__ */ m(q, {
		variant: "secondary",
		size: "md",
		...n,
		children: [/* @__PURE__ */ p(r, {}), t ?? ar[e]]
	});
}
//#endregion
//#region src/components/ui/PageHeader.tsx
function cr({ title: e, subtitle: t, actions: n, className: r }) {
	return /* @__PURE__ */ m("div", {
		className: R("flex items-center justify-between", r),
...
function lr({ title: e, description: t, actions: n, children: r, as: i = "h2", className: a, headerClassName: o, contentClassName: s }) {
	return /* @__PURE__ */ m("section", {
		className: R("space-y-4", a),
		children: [(e || t || n) && /* @__PURE__ */ m("div", {
			className: R("border-border flex items-end justify-between gap-3 border-b pb-2", o),
			children: [/* @__PURE__ */ m("div", {
				className: "min-w-0",
...
function dr({ page: e, pageSize: t, total: n, pageSizeOptions: r = ur, onPageChange: i, onPageSizeChange: a, className: o }) {
	let s = Math.ceil(n / t), c = Math.min((e - 1) * t + 1, n), l = Math.min(e * t, n);
	return /* @__PURE__ */ m("div", {
		className: R("flex items-center justify-between", o),
		children: [/* @__PURE__ */ m("div", {
...
var fr = r(({ label: e, error: t, className: n, id: r, ...i }, a) => {
	...
	return /* @__PURE__ */ m("div", {
		...
		children: [(e || t) && /* @__PURE__ */ m("div", {
			...
			children: [/* @__PURE__ */ p("input", {
				...
				className: R("bg-bg-secondary text-text-primary h-7 w-full rounded-md border px-2 pr-8 text-xs", "placeholder:text-text-disabled", "transition-colors duration-[100ms]", "focus:border-accent focus:outline-none", t ? "border-red" : "border-border", n),
				...i
			}), /* @__PURE__ */ p("button", {
				type: "button",
				onClick: () => c(!s),
...
function pr({ name: e, subtitle: t, badge: n, meta: r, action: i, className: a }) {
	return /* @__PURE__ */ m("div", {
		className: R("flex items-start gap-4", a),
		children: [
			/* @__PURE__ */ p(yt, {
				name: e,
				size: "lg"
...
function mr({ children: e, className: t }) {
	return /* @__PURE__ */ p("div", {
		className: R("ui-prose", t),
		children: e
	});
}
//#endregion
//#region src/components/ui/RadioPill.tsx
function hr({ options: e, value: t, onChange: n, disabled: r, className: i, "aria-label": a }) {
	return /* @__PURE__ */ p("div", {
		role: "radiogroup",
		"aria-label": a,
		className: R("border-border inline-flex overflow-hidden rounded-md border", r && "cursor-not-allowed opacity-40", i),
		children: e.map((e) => /* @__PURE__ */ p("button", {
			role: "radio",
			"aria-checked": e.value === t,
			disabled: r,
			onClick: () => n(e.value),
			className: R("font-control px-3 py-1.5 text-xs font-medium transition-colors duration-[100ms]", "focus-visible:outline-accent focus-visible:outline-2 focus-visible:outline-offset-[-2px]", !r && "cursor-pointer", e.value === t ? "bg-accent text-text-on-accent" : "bg-bg-secondary text-text-secondary hover:bg-bg-hover hover:text-text-primary"),
			children: e.label
		}, e.value))
	});
}
...
function gr({ value: e, onChange: t, placeholder: n = "Search...", className: r }) {
	return /* @__PURE__ */ m("div", {
		className: R("relative", r),
		children: [/* @__PURE__ */ p(se, { className: "text-text-tertiary absolute top-1/2 left-2 h-3.5 w-3.5 -translate-y-1/2" }), /* @__PURE__ */ p("input", {
			type: "search",
			value: e,
			onChange: (e) => t(e.target.value),
			placeholder: n,
			className: R("bg-bg-secondary text-text-primary h-7 w-full pr-2 pl-7 text-xs", "border-border rounded-md border", "placeholder:text-text-disabled", "transition-colors duration-[100ms]", "focus:border-accent focus:outline-none")
		})]
	});
}
//#endregion
//#region src/components/ui/Select.tsx
var _r = r(({ label: e, error: t, options: n, className: r, id: i, ...a }, o) => {
	...
	return /* @__PURE__ */ m("div", {
		...
		children: [(e || t) && /* @__PURE__ */ m("div", {
			...
			children: [/* @__PURE__ */ p("select", {
				ref: o,
				id: s,
				className: R("bg-bg-secondary text-text-primary font-control h-7 w-full px-2 pr-7 text-xs", "appearance-none rounded-md border", "transition-colors duration-[100ms]", "focus:border-accent focus:outline-none", "disabled:cursor-not-allowed disabled:opacity-40", "cursor-pointer", t ? "border-red" : "border-border", r),
				...a,
...
function vr({ label: e, description: t, action: n, className: r }) {
	return /* @__PURE__ */ m("div", {
		className: R("border-border flex items-center justify-between border-b py-3", r),
		children: [/* @__PURE__ */ m("div", {
...
function yr({ open: e, onClose: t, title: n, children: r, footer: i, side: a = "right", widthClassName: s = "w-[360px]", className: c, contentClassName: l }) {
	let d = u(null);
	return V(d, e), o(() => {
		if (!e) return;
		let n = (e) => {
		...
		children: [
			...
			/* @__PURE__ */ m("div", {
				ref: d,
				className: R("bg-bg-secondary border-border flex flex-col shadow-lg", s, a === "right" ? "animate-slide-in-right border-l" : "animate-slide-in-left border-r", c),
				...
				children: [
					...
					/* @__PURE__ */ p("div", {
						className: R("flex-1 overflow-y-auto p-3", l),
						children: r
					}),
					i && /* @__PURE__ */ p("div", {
...
function br({ children: e, direction: t = "row", className: n }) {
	return /* @__PURE__ */ p("div", {
		className: R("-m-4 md:-m-6", "flex h-[calc(100vh-var(--topbar-height)-var(--bottomnav-height))] gap-0 md:h-[calc(100vh-var(--topbar-height))]", t === "column" && "flex-col", n),
		children: e
	});
}
function xr({ children: e, className: t }) {
	return /* @__PURE__ */ p("div", {
		className: R("flex min-h-0 min-w-0 flex-1 flex-col overflow-hidden", t),
		children: e
	});
}
var Sr = Object.assign(br, { Main: xr }), Cr = {
	active: "bg-green",
...
function Tr({ status: e, label: t, className: n }) {
	return /* @__PURE__ */ m("span", {
		className: R("inline-flex items-center gap-1.5", n),
		children: [/* @__PURE__ */ p("span", { className: R("h-2 w-2 rounded-full", Cr[e]) }), t && /* @__PURE__ */ p("span", {
			className: R("text-xs", wr[e]),
			children: t
		})]
	});
}
...
function Er({ steps: e, currentStep: t, className: n }) {
	return /* @__PURE__ */ p("div", {
		className: R("flex items-center justify-between", n),
		children: e.map((n, r) => /* @__PURE__ */ m("div", {
			...
			children: [/* @__PURE__ */ m("div", {
				...
				children: [
					/* @__PURE__ */ p("div", {
						className: R("flex h-8 w-8 items-center justify-center rounded-full text-xs", r < t && "bg-accent text-text-on-accent", r === t && "border-accent text-accent border-2 font-semibold", r > t && "bg-bg-tertiary border-border text-text-tertiary border"),
						children: r < t ? /* @__PURE__ */ p(S, { className: "h-4 w-4" }) : r + 1
					}),
					/* @__PURE__ */ p("span", {
						className: R("text-2xs mt-1.5 hidden sm:block", r === t && "text-accent", r < t && "text-text-primary", r > t && "text-text-tertiary"),
						children: n.label
					}),
			...
			}), r < e.length - 1 && /* @__PURE__ */ p("div", { className: R("mx-2 h-0.5 flex-1", r < t ? "bg-accent" : "bg-border") })]
		}, n.label))
	});
}
//#endregion
//#region src/components/ui/Tabs.tsx
function Dr({ tabs: e, defaultTab: t, value: n, onChange: r, className: i }) {
	...
	return /* @__PURE__ */ m("div", {
		...
		children: [/* @__PURE__ */ p("div", {
			...
			children: e.map((e) => /* @__PURE__ */ m("button", {
				...
				onClick: () => f(e.key),
				onKeyDown: _,
				className: R("font-control relative cursor-pointer px-3 py-2 text-xs font-medium transition-colors duration-[100ms]", "hover:text-text-primary", e.key === c ? "text-accent" : "text-text-tertiary"),
...
var Or = r(({ label: e, error: t, showCount: n, maxLength: r, value: i, className: a, id: o, ...s }, c) => {
	...
	return /* @__PURE__ */ m("div", {
		...
		children: [
			...
			/* @__PURE__ */ p("textarea", {
				...
				value: i,
				maxLength: r,
				className: R("bg-bg-secondary text-text-primary font-control min-h-[72px] w-full px-2 py-1.5 text-xs", "resize-y rounded-md border", "placeholder:text-text-disabled", "transition-colors duration-[100ms]", "focus:border-accent focus:outline-none", t ? "border-red" : "border-border", a),
				...s
			}),
			/* @__PURE__ */ m("div", {
...
var kr = r(({ label: e, error: t, icon: n, className: r, id: i, readOnly: a, ...o }, s) => {
	...
	return /* @__PURE__ */ m("div", {
		...
		children: [(e || t) && /* @__PURE__ */ m("div", {
			...
			children: [n && /* @__PURE__ */ p("span", {
				...
				id: c,
				readOnly: a,
				className: R("bg-bg-secondary text-text-primary font-control h-7 w-full px-2 text-xs", "rounded-md border", "placeholder:text-text-disabled", "transition-colors duration-[100ms]", "focus:border-accent focus:outline-none", "disabled:cursor-not-allowed disabled:opacity-40", a && "bg-bg-primary text-text-secondary focus:border-border cursor-default border-dashed", n && "pl-7", t ? "border-red" : !a && "border-border", a && !t && "border-border", r),
				...o
			})]
		})]
	});
});
kr.displayName = "TextInput";
//#endregion
//#region src/components/ui/Timeline.tsx
function Ar({ items: e, className: t }) {
	return /* @__PURE__ */ p("div", {
		className: R("space-y-0", t),
		children: e.map((t, n) => /* @__PURE__ */ m("div", {
			className: "flex gap-3",
			children: [/* @__PURE__ */ m("div", {
				className: "flex flex-col items-center",
				children: [/* @__PURE__ */ p("div", { className: R(t.dot, "mt-1.5 h-2 w-2 shrink-0 rounded-full") }), n < e.length - 1 && /* @__PURE__ */ p("div", { className: "bg-border mt-1 w-px flex-1" })]
			}), /* @__PURE__ */ m("div", {
				className: R("pb-4", n === e.length - 1 && "pb-0"),
				children: [/* @__PURE__ */ p("p", {
					className: "text-text-primary text-xs",
					children: t.text
				}), /* @__PURE__ */ p("p", {
...
function Mr({ content: e, placement: t = "top", children: n }) {
	let [r, i] = d(!1), a = s();
	return /* @__PURE__ */ m("div", {
		...
		children: [n, r && /* @__PURE__ */ p("div", {
			id: a,
			className: R("text-2xs absolute z-50 px-2 py-1 font-medium whitespace-nowrap", "bg-bg-tertiary text-text-primary border-border rounded border shadow-md", "animate-fade-in pointer-events-none", jr[t]),
			role: "tooltip",
			children: e
		})]
	});
...
function Nr({ start: e, end: t, children: n, className: r, startClassName: i, endClassName: a }) {
	return /* @__PURE__ */ m("div", {
		className: R("flex items-center justify-between gap-3", r),
		children: [/* @__PURE__ */ p("div", {
			className: R("flex flex-1 items-center gap-3", i),
			children: e ?? n
		}), t && /* @__PURE__ */ p("div", {
			className: R("flex items-center gap-1.5", a),
			children: t
		})]
	});
}
...
function Pr({ title: e = "Drag and drop files here, or click to browse", description: t, icon: n, accept: r, multiple: i, disabled: a, onChange: o, className: s }) {
	return /* @__PURE__ */ m("label", {
		className: R("border-border hover:border-border-strong block rounded-md border-2 border-dashed p-8 text-center transition-colors duration-[100ms]", a ? "cursor-not-allowed opacity-60" : "cursor-pointer hover:bg-bg-hover", s),
		children: [
			/* @__PURE__ */ p("input", {
				type: "file",
				accept: r,
			...
			/* @__PURE__ */ p("div", {
				...
				children: n ?? /* @__PURE__ */ p(ue, { className: "h-4.5 w-4.5" })
			}),
			/* @__PURE__ */ p("p", {
...
}, Hr = "leonardaustin-ui-settings", Ur = new Set(Object.keys(Vr)), Wr = new Set(Object.keys(U)), Q = new Set(Object.keys(Z)), Gr = new Set([
	"light",
	"dark",
	"system"
]);
...
function Kr(e) {
	let t = {};
	if (Ur.has(e.accentColor) && (t.accentColor = e.accentColor), Gr.has(e.colorMode) && (t.colorMode = e.colorMode), Wr.has(e.preferredDarkTheme) && !H(e.preferredDarkTheme) && (t.preferredDarkTheme = e.preferredDarkTheme), Wr.has(e.preferredLightTheme) && H(e.preferredLightTheme) && (t.preferredLightTheme = e.preferredLightTheme), typeof e.sidebarCollapsed == "boolean" && (t.sidebarCollapsed = e.sidebarCollapsed), typeof e.reducedMotion == "boolean" && (t.reducedMotion = e.reducedMotion), typeof e.sidebarWidth == "number" && (t.sidebarWidth = $(e.sidebarWidth, 160, 400, 220)), e.themeOverrides && typeof e.themeOverrides == "object") {
		let n = {};
		for (let [t, r] of Object.entries(e.themeOverrides)) {
			if (!Wr.has(t) || !r || typeof r != "object") continue;
			let e = r, i = U[t];
			n[t] = {
...
function Jr(e) {
	if (typeof localStorage > "u") return qr;
	try {
...
function Zr({ children: e, storageKey: t = Hr }) {
	let [n, r] = d(() => Jr(t)), [a, s] = d(() => typeof window < "u" && window.matchMedia("(prefers-color-scheme: dark)").matches);
	o(() => {
	...
	let c = l(() => n.colorMode === "light" ? n.preferredLightTheme : n.colorMode === "dark" || a ? n.preferredDarkTheme : n.preferredLightTheme, [
		...
		a
	]), [u, f] = d(() => Yr(c, n.themeOverrides));
	o(() => {
		f(Yr(c, n.themeOverrides));
	}, [c]);
	let m = i((e) => {
		r((n) => {
			let r = {
	...
	o(() => {
		let e = document.documentElement, t = Vr[n.accentColor];
	...
	let h = l(() => Yr(c, n.themeOverrides), [c, n.themeOverrides]), g = c in n.themeOverrides, _ = !Xr(u, h), v = i(() => {
		m({ themeOverrides: {
			...n.themeOverrides,
			[c]: { ...u }
		} });
...
function $r({ children: e }) {
	let { resolvedTheme: t } = a(ht);
	return o(() => {
		let e = document.documentElement;
		Object.values(Qr).forEach((t) => {
			t && e.classList.remove(t);
		});
		let n = Qr[t];
		n && e.classList.add(n);
	}, [t]), /* @__PURE__ */ p(Fr.Provider, {
		value: { theme: t },
		children: e
	});
}
//#endregion
export { pn as Alert, nn as AppShell, me as AreaChart, mn as AuthCard, rn as AuthLayout, hn as AuthorByline, yt as Avatar, an as BackLink, vn as Badge, ge as BarChart, Qe as BottomNav, Lt as Breadcrumbs, q as Button, et as COMMAND_PALETTE_EVENT, Tn as CalendarGrid, En as Card, on as Checkbox, cn as ColumnPicker, Dn as Combobox, at as CommandPalette, tt as DEFAULT_COMMAND_PALETTE_SHORTCUT, On as DangerZone, An as DatePicker, Pn as DateRangePicker, Bn as DateTimePicker, Wn as DetailPanel, Gn as Dialog, Kn as DialogActions, qn as DividerLabel, Ve as DonutChart, Jn as DropdownMenu, Yn as EmptyState, Xn as ErrorBoundary, sn as FilterButton, Zn as FilterDropdown, Qn as Kbd, er as LoadingSpinner, tr as MetadataGrid, nr as MetricCard, st as MobileDrawer, sr as OAuthButton, cr as PageHeader, lr as PageSection, ln as Pagination, dr as PaginationBar, fr as PasswordInput, pr as ProfileHeader, mr as ProseContent, Ue as RadarChart, Ge as RadialBarChart, hr as RadioPill, dn as ResourceTable, gr as SearchInput, J as SectionHeader, _r as Select, Y as SelectDropdown, vr as SettingRow, ht as SettingsContext, Zr as SettingsProvider, yr as SideSheet, Ft as Sidebar, X as Slider, Ke as SparkLine, Sr as SplitPaneLayout, Tr as StatusDot, Er as StepProgress, Jt as THEME_MENU_EVENT, Dr as Tabs, kr as TextInput, Or as Textarea, Fr as ThemeContext, Zt as ThemeMenu, Kt as ThemePreview, $r as ThemeProvider, Ar as Timeline, St as ToastProvider, qt as Toggle, Nr as Toolbar, Mr as Tooltip, tn as TopBar, Pr as UploadDropzone, Ye as VerticalBarChart, mt as accentItems, R as cn, dt as darkThemes, W as fontOptions, zr as formatDateLong, Rr as formatDateShort, Br as formatRelative, B as handleAppShellNavigate, Xe as isAppShellPathActive, H as isLightTheme, ut as lightThemes, rt as matchesCommandPaletteShortcut, Ze as navigateToPath, nt as openCommandPalette, Yt as openThemeMenu, un as sortRows, U as themeDefaults, ct as themeItems, Rt as useApplyTheme, G as useDismiss, V as useFocusTrap, K as useSettings, Ir as useTheme, xt as useToast };
