...
import { Accessibility as h, AlertTriangle as g, ArrowDown as _, ArrowLeft as v, ArrowUp as y, BookOpen as b, Calendar as x, Check as S, CheckCircle2 as C, ChevronDown as w, ChevronLeft as T, ChevronRight as E, ChevronsUpDown as D, Columns3 as O, Eye as k, EyeOff as A, Inbox as ee, Info as te, Loader2 as ne, LogOut as re, Menu as ie, Minus as ae, Monitor as j, Moon as M, Palette as oe, PanelLeft as se, PanelLeftDashed as ce, Search as N, Settings as le, Sun as ue, UploadCloud as de, X as P, XCircle as fe, Zap as pe } from "lucide-react";
...
function he({ data: e, height: t = 240 }) {
	let n = s(), r = u(null), [i, a] = d(null), o = 600 - I.left - I.right, c = t - I.top - I.bottom, l = Math.min(...e.map((e) => e.value)), h = Math.max(...e.map((e) => e.value)), g = h - l || 1;
	function _(t) {
		return I.left + t / Math.max(e.length - 1, 1) * o;
	}
	function v(e) {
		return I.top + c - (e - l) / g * c;
	}
	let y = e.map((e, t) => `${_(t)},${v(e.value)}`).join(" "), b = [
		`${_(0)},${I.top + c}`,
		...e.map((e, t) => `${_(t)},${v(e.value)}`),
		`${_(e.length - 1)},${I.top + c}`
	...
	function w(t) {
		...
		let i = n.getBoundingClientRect(), s = ((t.clientX - i.left) / i.width * 600 - I.left) / o, c = Math.round(s * (e.length - 1)), l = Math.max(0, Math.min(e.length - 1, c));
		a({
			x: _(l),
			y: v(e[l].value),
			index: l
...
var ye = new Set([
	...
	"text-left",
	"text-right"
]), Se = new Set(["lowercase", "uppercase"]), Ce = new Set([
	"font-bold",
	"font-medium",
	"font-normal",
	"font-semibold"
...
function Ae(e) {
	let t = je(e), n = t.pop() ?? e, r = n.startsWith("!"), i = Me(r ? n.slice(1) : n), a = `${t.join(":")}|${r ? "!" : ""}`, o = Ne(i);
...
function He({ segments: e, size: t = 180 }) {
	let [n, r] = d(null), i = e.reduce((e, t) => e + t.value, 0), a = (t - 28) / 2, o = Ve(e, 2 * Math.PI * a), s = t + 12, c = s / 2;
	return /* @__PURE__ */ m("div", {
		...
		children: [/* @__PURE__ */ m("div", {
			...
			children: [/* @__PURE__ */ m("svg", {
				...
				children: [
					...
					o.map((e, t) => {
						...
						return /* @__PURE__ */ p("circle", {
							...
							r: a,
							fill: "none",
							stroke: Be[e.segment.color] ?? "var(--accent)",
							strokeWidth: r ? 32 : 28,
							strokeDasharray: `${e.segmentLength} ${e.dashOffset}`,
							strokeLinecap: "butt",
				...
				let e = o[n], t = e.midAngle * Math.PI / 180, r = a + 28 / 2 + 20, i = c + Math.cos(t) * r, s = c + Math.sin(t) * r, l = Be[e.segment.color] ?? "var(--accent)";
			...
			children: e.map((e, t) => /* @__PURE__ */ m("button", {
				...
				onMouseEnter: () => r(t),
				onMouseLeave: () => r(null),
				className: L("flex cursor-pointer items-center gap-1.5 transition-opacity duration-[100ms]", n !== null && n !== t && "opacity-50"),
				children: [
					/* @__PURE__ */ p("span", {
						className: "h-2 w-2 rounded-full",
						style: { backgroundColor: Be[e.color] ?? "var(--accent)" }
					}),
					/* @__PURE__ */ p("span", {
...
var Ue = 4;
function We({ data: e, maxValue: t, size: n = 240 }) {
		...
		children: [/* @__PURE__ */ m("svg", {
			...
			children: /* @__PURE__ */ m("div", {
				...
				children: [
					...
					/* @__PURE__ */ p("span", {
						className: L("text-text-secondary text-xs whitespace-nowrap"),
						children: e[r].label
					}),
					/* @__PURE__ */ p("span", {
						className: "text-text-primary text-xs font-semibold",
...
function Ke({ segments: e, size: t = 200 }) {
		...
		children: [/* @__PURE__ */ m("div", {
			...
			children: [/* @__PURE__ */ m("svg", {
				...
				children: [e.map((e, t) => {
					let i = c - t * 20;
					if (i <= 0) return null;
					let a = 2 * Math.PI * i, o = a * Math.min(e.value / e.max, 1), l = a - o, u = Ge[e.color] ?? "var(--accent)", d = n === t;
					return /* @__PURE__ */ m("g", {
						onMouseEnter: () => r(t),
						onMouseLeave: () => r(null),
						className: "cursor-pointer",
				...
				let t = e[n], r = Math.round(t.value / t.max * 100), a = Ge[t.color] ?? "var(--accent)";
				return /* @__PURE__ */ p("div", {
					className: "bg-bg-tertiary border-border pointer-events-none absolute z-10 rounded-md border px-2.5 py-1.5 shadow-lg",
					style: {
						left: i.x,
			...
			children: e.map((e, t) => {
				...
				return /* @__PURE__ */ m("button", {
					...
					children: [
						/* @__PURE__ */ p("span", {
							className: "h-2 w-2 rounded-full",
							style: { backgroundColor: Ge[e.color] ?? "var(--accent)" }
						}),
						/* @__PURE__ */ p("span", {
							className: "text-text-secondary text-xs",
							children: e.label
...
function qe({ data: e, width: t = 60, height: n = 20, color: r }) {
...
function Xe({ data: e, height: t = 180 }) {
	let [n, r] = d(null), i = 600 - R.left - R.right, a = t - R.top - R.bottom, o = Math.max(...e.map((e) => e.value), 1), s = Math.max(4, (i - 6 * (e.length - 1)) / e.length);
	return /* @__PURE__ */ m("svg", {
		width: "100%",
		viewBox: `0 0 600 ${t}`,
		className: "select-none",
		children: [
			...
			e.map((e, i) => {
				let c = R.left + i * (s + 6), l = e.value / o * a, u = R.top + a - l, d = n === i;
				return /* @__PURE__ */ m("g", {
					onMouseEnter: () => r(i),
					onMouseLeave: () => r(null),
					children: [
...
function $e({ items: e, currentPath: t, onNavigate: n, className: r }) {
	return e.length === 0 ? null : /* @__PURE__ */ p("nav", {
		className: L("bg-bg-secondary border-border font-navigation fixed right-0 bottom-0 left-0 z-30 border-t md:hidden", r),
		...
		children: /* @__PURE__ */ p("ul", {
			...
			children: e.map((e) => {
				...
				return /* @__PURE__ */ p("li", { children: /* @__PURE__ */ m("a", {
					href: e.path,
					onClick: (t) => z(t, e.path, n),
					"aria-current": r ? "page" : void 0,
					className: L("font-navigation flex h-full w-14 flex-col items-center justify-center gap-0.5", "cursor-pointer transition-colors duration-[100ms]", r ? "text-accent" : "text-text-tertiary"),
...
function B(e, t) {
	...
	o(() => {
		...
		let i = e.current.querySelectorAll(et);
	...
	return f ? /* @__PURE__ */ m("div", {
		...
		children: [/* @__PURE__ */ p("div", {
			...
			children: [/* @__PURE__ */ m("div", {
				...
				children: [
					/* @__PURE__ */ p(N, { className: "text-text-tertiary h-4 w-4 shrink-0" }),
					/* @__PURE__ */ p("input", {
						ref: b,
						type: "text",
						role: "combobox",
				...
				children: C.length === 0 ? /* @__PURE__ */ p("li", {
					...
					"aria-selected": t === v,
					onClick: () => E(e),
					className: L("flex h-9 w-full cursor-pointer items-center gap-3 rounded-md px-3 text-left", "transition-colors duration-[100ms]", t === v ? "bg-accent-muted text-accent" : "text-text-secondary hover:text-text-primary hover:bg-bg-hover"),
...
function ct({ open: e, onClose: t, items: n, brand: r, currentPath: i, onNavigate: a, className: s }) {
	...
	return B(c, e), o(() => {
		...
		let n = (e) => {
			e.key === "Escape" && t();
		}, r = c.current?.ownerDocument ?? document;
		...
		children: [/* @__PURE__ */ p("div", {
			...
			ref: c,
			className: L("bg-bg-sidebar border-border animate-slide-in-left fixed inset-y-0 left-0 z-50 flex w-64 flex-col border-r", s),
			children: [/* @__PURE__ */ m("div", {
				...
				children: [/* @__PURE__ */ p(st, { brand: r }), /* @__PURE__ */ p("button", {
					...
					children: /* @__PURE__ */ p(P, { className: "h-4 w-4" })
				})]
			}), /* @__PURE__ */ p("nav", {
				...
				children: /* @__PURE__ */ p("ul", {
					...
					children: n.map((e) => {
						...
						return /* @__PURE__ */ p("li", { children: /* @__PURE__ */ m("a", {
							href: e.path,
							onClick: (n) => z(n, e.path, a, t),
							"aria-current": n ? "page" : void 0,
							className: L("flex h-10 items-center gap-3 rounded-md px-3", "cursor-pointer transition-colors duration-[100ms]", n ? "bg-accent-muted text-accent" : "text-text-secondary hover:text-text-primary hover:bg-bg-hover"),
...
var dt = lt.filter((e) => V(e.value)), ft = lt.filter((e) => !V(e.value)), pt = {
	uiFont: "inter",
	headingFont: "inter",
	proseFont: "inter",
	controlFont: "inter",
...
function K({ name: e, src: t, size: n = "md", className: r }) {
	return /* @__PURE__ */ p("div", {
		className: L("text-text-on-avatar flex shrink-0 items-center justify-center rounded-full font-semibold", _t[n], r),
		style: { backgroundColor: t ? void 0 : yt(e) },
		"aria-label": e,
...
function Et({ toast: e, onDismiss: t }) {
	...
	return o(() => {
		...
		children: [
			/* @__PURE__ */ p("div", { className: L("absolute top-1.5 bottom-1.5 left-0 w-[3px] rounded-md", wt[e.type]) }),
			/* @__PURE__ */ m("div", {
				className: "flex items-center gap-2.5 p-3 pl-3.5",
				children: [
					/* @__PURE__ */ p(i, { className: L("h-4 w-4 shrink-0", Tt[e.type]) }),
					/* @__PURE__ */ p("p", {
					...
					/* @__PURE__ */ p("button", {
						...
						children: /* @__PURE__ */ p(P, { className: "h-3 w-3" })
					})
				]
			}),
			/* @__PURE__ */ p("div", {
...
function At({ item: e, collapsed: t, currentPath: n, onNavigate: r }) {
	...
	return /* @__PURE__ */ m("a", {
		href: e.path,
		onClick: (t) => z(t, e.path, r),
		"aria-current": i ? "page" : void 0,
		className: L("font-navigation relative flex items-center gap-2 rounded px-2", "cursor-pointer transition-colors duration-[100ms]", t ? "mx-auto w-[2em] justify-center" : "", i ? "bg-accent-muted text-accent" : "text-text-secondary hover:text-text-primary hover:bg-bg-hover"),
		style: { height: "2em" },
...
function jt({ brand: e, collapsed: t }) {
	...
	return e.logo && !t ? /* @__PURE__ */ p("div", {
		...
		className: L("flex min-w-0 items-center gap-2 px-2", t && "mx-auto justify-center px-0"),
...
function Nt({ collapsed: e, accounts: t, initialAccountIndex: n = 0, onAccountChange: r, onSignOut: a, signOutPath: o, signOutLabel: s = "Sign out", onNavigate: c }) {
	...
	return C ? /* @__PURE__ */ m(f, { children: [/* @__PURE__ */ m("button", {
		ref: b,
		onClick: T,
		className: L("font-navigation flex w-full cursor-pointer items-center gap-2 rounded px-2 transition-colors duration-[100ms]", "text-text-secondary hover:text-text-primary hover:bg-bg-hover", e && "justify-center px-0"),
		style: { height: "2.5em" },
		...
		children: [
			...
			w && /* @__PURE__ */ m(f, { children: [/* @__PURE__ */ p("div", { className: "border-border my-1 border-t" }), /* @__PURE__ */ m("button", {
				...
				children: [/* @__PURE__ */ p(re, { className: "h-3.5 w-3.5" }), /* @__PURE__ */ p("span", { children: s })]
			})] })
		]
	}), document.body)] }) : null;
}
function Pt({ collapsed: e, settingsPath: t, settingsLabel: n = "All Settings", onOpenSettings: r, onNavigate: a }) {
	let [o, s] = d(!1), [c, l] = d({
		bottom: 0,
		left: 0
	}), g = u(null), _ = u(null), { accentColor: v, setAccentColor: y, reducedMotion: b, setReducedMotion: x, colorMode: C, setColorMode: w } = G(), { toast: T } = xt(), E = !!(t || r);
	W(o, i(() => s(!1), []), [_], [g]);
	function D() {
		if (!g.current) return;
	...
	return /* @__PURE__ */ m(f, { children: [/* @__PURE__ */ m("button", {
		ref: g,
		onClick: D,
		className: L("font-navigation relative flex w-full items-center gap-2 rounded px-2", "cursor-pointer transition-colors duration-[100ms]", e ? "mx-auto w-[2em] justify-center" : "", o ? "bg-accent-muted text-accent" : "text-text-secondary hover:text-text-primary hover:bg-bg-hover"),
		style: { height: "2em" },
		title: e ? "Settings" : void 0,
		children: [/* @__PURE__ */ p(le, { className: "h-3.5 w-3.5 shrink-0" }), !e && /* @__PURE__ */ p("span", {
			className: "truncate text-xs",
			children: "Settings"
		})]
	}), o && F(/* @__PURE__ */ m("div", {
		...
		children: [
			...
			/* @__PURE__ */ p("div", {
				...
				children: ht.map((e) => /* @__PURE__ */ p("button", {
					onClick: () => y(e.value),
					className: L("h-5 w-5 cursor-pointer rounded-full transition-transform duration-[100ms] hover:scale-110", v === e.value && "ring-offset-bg-tertiary scale-110 ring-2 ring-offset-1"),
					style: {
			...
			E && /* @__PURE__ */ m(f, { children: [/* @__PURE__ */ p("div", { className: "border-border my-1 border-t" }), /* @__PURE__ */ m("button", {
				onClick: O,
				className: "text-text-secondary hover:text-text-primary hover:bg-bg-hover font-navigation flex h-7 w-full cursor-pointer items-center gap-2.5 px-3 text-xs transition-colors duration-[100ms]",
				children: [/* @__PURE__ */ p(le, { className: "h-3.5 w-3.5 shrink-0" }), /* @__PURE__ */ p("span", {
					className: "flex-1 text-left",
					children: n
				})]
			})] })
...
function Ft({ navSections: e, brand: t, accounts: n = [], initialAccountIndex: r, onAccountChange: a, onSignOut: o, signOutPath: s, signOutLabel: c, settingsPath: l, settingsLabel: f, onOpenSettings: h, currentPath: g, onNavigate: _, className: v }) {
	let { sidebarCollapsed: y, sidebarWidth: b, setSidebarWidth: x } = G(), [S, C] = d(/* @__PURE__ */ new Set()), T = u(null), E = u(!1), D = i((e) => {
		if (y) return;
	...
	return /* @__PURE__ */ m("aside", {
		ref: T,
		className: L("bg-bg-secondary relative hidden shrink-0 flex-col border-r md:flex", "transition-[width] duration-[200ms] ease-out", "border-border", v),
		style: { width: y ? kt : b },
		children: [
			!y && /* @__PURE__ */ p("div", {
				onMouseDown: D,
					...
					return /* @__PURE__ */ m("div", {
						...
						children: [y ? t > 0 && /* @__PURE__ */ p("hr", { className: "border-border mx-auto my-1.5 w-4/5" }) : /* @__PURE__ */ m("button", {
							...
							children: [/* @__PURE__ */ p("span", {
								...
								children: e.title
							}), /* @__PURE__ */ p(w, { className: L("h-3 w-3 shrink-0 transition-transform", n && "-rotate-90") })]
						}), (!n || y) && /* @__PURE__ */ p("ul", {
...
function Lt({ homeLabel: e = "Dashboard", labels: t = {}, parents: n = {}, currentPath: r = "/", onNavigate: i, className: a }) {
	...
	return /* @__PURE__ */ p("nav", {
		...
		className: L("font-navigation flex items-center gap-1 text-xs", a),
		children: s.map((e, t) => {
			let n = t === s.length - 1;
			return /* @__PURE__ */ m("span", {
				...
				children: [t > 0 && /* @__PURE__ */ p(E, { className: "text-text-tertiary h-3 w-3" }), n ? /* @__PURE__ */ p("span", {
					...
					href: e.path,
					onClick: (t) => z(t, e.path, i),
					className: L("text-text-tertiary hover:text-text-primary cursor-pointer transition-colors duration-[100ms]"),
					children: e.label
				})]
			}, e.path);
		})
...
function Rt() {
	let { setPreferredDarkTheme: e, setPreferredLightTheme: t, setColorMode: n } = G();
	return i((r) => {
...
var zt = {
	...
	return /* @__PURE__ */ m("button", {
		ref: l,
		disabled: s || n,
		className: L("inline-flex items-center justify-center rounded-md font-medium", "font-control", "transition-colors duration-[100ms] ease-out", "cursor-pointer", "disabled:cursor-not-allowed disabled:opacity-40", "focus-visible:outline-accent focus-visible:outline-2 focus-visible:outline-offset-2", zt[e], u ? Vt[t] : Bt[t], d && !u && Wt[d]?.[t], a),
		...c,
		children: [
			n && /* @__PURE__ */ p(ne, { className: "h-3.5 w-3.5 animate-spin" }),
...
function J({ children: e, as: t = "h2", className: n, border: r = !0 }) {
	return /* @__PURE__ */ p(t, {
		className: L("text-text-primary font-heading text-xs font-semibold", r && "border-border border-b pb-2", n),
		children: e
	});
}
//#endregion
...
function Y({ options: e, value: t, onChange: n, label: r, placeholder: a = "Select...", className: o, size: c = "md" }) {
	...
	return /* @__PURE__ */ m("div", {
		className: L("flex flex-col gap-1.5", o),
		ref: _,
		children: [r && /* @__PURE__ */ p("span", {
			...
			children: [
				/* @__PURE__ */ p("button", {
					...
					className: L("font-control flex w-full cursor-pointer items-center rounded-md text-xs", "bg-bg-secondary border-border text-text-primary border", "hover:bg-bg-hover hover:border-border-strong", "transition-colors duration-[100ms]", "focus-visible:outline-accent focus-visible:outline-2 focus-visible:outline-offset-2", c === "sm" ? "h-6 px-2 pr-6" : "h-7 px-2 pr-7"),
					children: C ? C.label : /* @__PURE__ */ p("span", {
						className: "text-text-disabled",
						children: a
					})
				}),
				/* @__PURE__ */ p(w, { className: L("text-text-tertiary pointer-events-none absolute top-1/2 h-3 w-3 -translate-y-1/2 transition-transform", c === "sm" ? "right-1.5" : "right-2", l && "rotate-180") }),
				l && /* @__PURE__ */ p("div", {
					ref: v,
					className: L("bg-bg-tertiary border-border-strong animate-scale-in absolute right-0 left-0 z-[100] overflow-hidden rounded-md border shadow-lg", y ? "bottom-full mb-1" : "top-full mt-1"),
					children: /* @__PURE__ */ p("ul", {
						id: x,
						...
						children: e.map((e, r) => /* @__PURE__ */ m("li", {
							...
							onMouseEnter: () => g(r),
							className: L("font-control flex h-7 w-full cursor-pointer items-center gap-2 px-3 text-xs", "transition-colors duration-[100ms]", r === h ? "bg-accent-muted text-accent" : e.value === t ? "text-accent" : "text-text-secondary hover:text-text-primary hover:bg-bg-hover"),
							children: [/* @__PURE__ */ p("span", {
...
function Kt({ label: e, active: t, icon: n, preview: r, onClick: i, className: a }) {
	return /* @__PURE__ */ m("button", {
		type: "button",
		onClick: i,
		className: L("flex cursor-pointer flex-col items-center gap-2 rounded-md border p-3 transition-colors duration-[100ms]", t ? "border-accent bg-accent-muted" : "border-border bg-bg-secondary hover:bg-bg-hover hover:border-border-strong", a),
		children: [/* @__PURE__ */ p("div", {
...
function qt({ checked: e, onChange: t, disabled: n, label: r, className: i }) {
	return /* @__PURE__ */ m("label", {
		className: L("flex w-fit items-center", n ? "cursor-not-allowed opacity-40" : "cursor-pointer", i),
		style: { gap: 10 },
		children: [/* @__PURE__ */ p("button", {
			...
			disabled: n,
			onClick: () => t(!e),
			className: L("relative shrink-0 rounded-full border transition-colors duration-[100ms]", "focus-visible:outline-accent focus-visible:outline-2 focus-visible:outline-offset-2", e ? "bg-accent border-accent" : "bg-bg-tertiary border-border", !n && "cursor-pointer"),
			style: {
				width: 36,
				height: 20
			},
...
function Zt({ className: e, respondToOpenEvent: t = !0 }) {
	let [n, r] = d(!1), [a, s] = d(!1), [c, l] = d({
		top: 0,
		right: 0
	}), h = u(null), g = u(null), _ = G(), v = Rt(), { toast: y } = xt(), b = i(() => {
		r(!1), s(!1);
	}, []);
	W(n, b, [g], [h], { outsideClick: !a });
	let x = i(() => {
		if (!h.current) return;
	...
	let { colorMode: C, setColorMode: w, preferredDarkTheme: T, preferredLightTheme: E, accentColor: D, setAccentColor: O, fontSize: k, setFontSize: A, uiFont: ee, setUiFont: te, headingFont: ne, setHeadingFont: re, proseFont: ie, setProseFont: ae, codeFont: j, setCodeFont: M, borderRadius: se, setBorderRadius: ce, borderWidth: N, setBorderWidth: le, tracking: ue, setTracking: de, lineHeight: P, setLineHeight: fe, density: pe, setDensity: I, reducedMotion: me, setReducedMotion: he, saveThemeCustomization: ge, resetThemeCustomization: _e, hasThemeOverrides: ve, isCustomized: ye, resolvedTheme: be } = _;
	return /* @__PURE__ */ m(f, { children: [/* @__PURE__ */ p("button", {
		...
		"aria-expanded": n,
		title: "Theme",
		className: L("flex h-7 w-7 cursor-pointer items-center justify-center rounded transition-colors duration-[100ms]", n ? "text-accent bg-accent-muted" : "text-text-tertiary hover:text-text-primary hover:bg-bg-hover", e),
		children: /* @__PURE__ */ p(oe, { className: "h-4 w-4" })
	}), n && F(/* @__PURE__ */ p("div", {
		ref: g,
		role: "dialog",
		"aria-label": "Theme settings",
			...
			children: [
				/* @__PURE__ */ m("div", { children: [/* @__PURE__ */ p(J, {
					...
					children: Xt.map(({ value: e, label: t, Icon: n }) => /* @__PURE__ */ m("button", {
						onClick: () => w(e),
						className: L("font-navigation flex flex-1 cursor-pointer items-center justify-center gap-1.5 rounded px-2 py-1 text-xs transition-colors duration-[100ms]", C === e ? "bg-accent-muted text-accent" : "text-text-secondary hover:text-text-primary hover:bg-bg-hover"),
				...
				/* @__PURE__ */ m("div", { children: [/* @__PURE__ */ p(J, {
					...
					children: ft.map((e) => /* @__PURE__ */ p(Kt, {
						label: e.label,
						icon: e.icon,
						preview: e.preview,
						active: T === e.value,
				...
				/* @__PURE__ */ m("div", { children: [/* @__PURE__ */ p(J, {
					...
					children: ht.map((e) => /* @__PURE__ */ p("button", {
						onClick: () => O(e.value),
						className: L("h-6 w-6 cursor-pointer rounded-full transition-transform duration-[100ms] hover:scale-110", D === e.value && "ring-offset-bg-tertiary scale-110 ring-2 ring-offset-1"),
						style: {
							backgroundColor: e.color,
				...
				/* @__PURE__ */ m("div", {
					...
					children: [/* @__PURE__ */ p(q, {
						...
						disabled: !ye,
						onClick: () => {
							ge(), y("success", `Saved customization for ${lt.find((e) => e.value === be)?.label ?? be}`);
						},
						...
						disabled: !ve && !ye,
						onClick: () => {
							_e(), y("info", "Reset to theme defaults");
						},
						children: "Reset"
					})]
				})
...
function tn({ onMobileMenuToggle: e, breadcrumbs: t, showCommandTrigger: n = !0, commandTriggerLabel: r = "Search", commandShortcut: i = nt, currentPath: a, onNavigate: o, onCommandTrigger: s }) {
	let { sidebarCollapsed: c, setSidebarCollapsed: l, colorMode: u, setColorMode: d } = G();
	function h() {
		d(Qt[(Qt.indexOf(u) + 1) % Qt.length]);
	}
	let g = $t[u];
		...
		children: [/* @__PURE__ */ m("div", {
			...
			children: [
				...
				/* @__PURE__ */ p("button", {
					...
					children: p(c ? ce : se, { className: "h-4 w-4" })
				}),
			...
			children: [
				n && /* @__PURE__ */ m("button", {
					...
					children: [
						/* @__PURE__ */ p(N, { className: "h-3 w-3" }),
						/* @__PURE__ */ p("span", {
							className: "text-2xs",
							children: r
						}),
				...
				/* @__PURE__ */ p("button", {
					...
					"aria-label": `Color mode: ${en[u]}. Click to cycle.`,
					title: en[u],
...
function nn({ children: e, navSections: t, brand: n, accounts: r, bottomNavItems: i = [], commandItems: a, breadcrumbs: o, initialAccountIndex: s, onAccountChange: c, onSignOut: u, signOutPath: f, signOutLabel: h, settingsPath: g, settingsLabel: _, onOpenSettings: v, showCommandPalette: y = !0, showCommandTrigger: b = !0, commandTriggerLabel: x, commandShortcut: S, currentPath: C, onNavigate: w, mainClassName: T, className: E }) {
	...
	return /* @__PURE__ */ m("div", {
		className: L("bg-bg-primary flex h-svh overflow-hidden", E),
		children: [
			/* @__PURE__ */ p("a", {
				href: "#main-content",
				className: "skip-link",
			...
			/* @__PURE__ */ m("div", {
				...
				children: [/* @__PURE__ */ p(tn, {
					...
					id: "main-content",
					className: L("flex-1 overflow-y-auto p-4 pb-20 md:p-6 md:pb-6", T),
					children: e
				})]
			}),
			/* @__PURE__ */ p($e, {
...
function rn({ children: e, className: t }) {
	return /* @__PURE__ */ m("div", {
		className: L("bg-bg-primary relative flex min-h-svh items-center justify-center p-4", t),
		children: [/* @__PURE__ */ p("div", {
...
function an({ to: e, children: t, onNavigate: n, className: r }) {
	return /* @__PURE__ */ m("a", {
		href: e,
		onClick: (t) => z(t, e, n),
		className: L("inline-flex items-center gap-1.5", "text-text-tertiary text-xs", "hover:text-text-primary", r),
...
function on({ checked: e, indeterminate: t, onChange: n, label: r, disabled: i, className: a }) {
	let o = e || t;
	return /* @__PURE__ */ m("label", {
		className: L("flex w-fit items-center gap-2.5", i ? "cursor-not-allowed opacity-40" : "cursor-pointer", a),
		children: [/* @__PURE__ */ p("button", {
			role: "checkbox",
			"aria-checked": t ? "mixed" : e,
			disabled: i,
			onClick: () => n(!e),
			className: L("flex h-4 w-4 shrink-0 items-center justify-center rounded border", "transition-colors duration-[100ms]", "focus-visible:outline-accent focus-visible:outline-2 focus-visible:outline-offset-2", o ? "bg-accent border-accent" : "bg-bg-secondary border-border", !i && "cursor-pointer"),
			children: t ? /* @__PURE__ */ p(ae, { className: "text-text-on-accent h-3 w-3" }) : e ? /* @__PURE__ */ p(S, { className: "text-text-on-accent h-3 w-3" }) : null
		}), r && /* @__PURE__ */ p("span", {
...
var sn = r(function({ icon: e, children: t, className: n, ...r }, i) {
	return /* @__PURE__ */ m("button", {
		ref: i,
		className: L("flex h-7 cursor-pointer items-center gap-1.5 rounded-md px-2.5", "border-border bg-bg-secondary text-text-secondary border", "hover:bg-bg-hover hover:border-border-strong", "text-xs", "transition-colors duration-[100ms]", n),
		...r,
	...
	return /* @__PURE__ */ m("div", {
		...
		children: [
			...
			r.map((t, r) => t === "ellipsis" ? /* @__PURE__ */ p("span", {
				...
				onClick: () => n(t),
				className: L("flex h-7 w-7 cursor-pointer items-center justify-center rounded text-xs font-medium", "transition-colors duration-[100ms]", t === e ? "bg-accent text-text-on-accent" : "text-text-secondary hover:text-text-primary hover:bg-bg-hover"),
				children: t
			}, t)),
			/* @__PURE__ */ p("button", {
				disabled: e === t,
		...
		children: /* @__PURE__ */ m("table", {
			...
			children: [/* @__PURE__ */ p("thead", { children: /* @__PURE__ */ p("tr", {
				...
				children: t.map((e) => /* @__PURE__ */ p("th", {
					className: L("text-2xs text-text-tertiary font-label h-7 px-3 text-left font-semibold tracking-wider uppercase", e.sortable && "hover:text-text-secondary cursor-pointer select-none"),
					style: { width: e.width },
				...
				className: L("border-border h-8 border-b last:border-b-0", "hover:bg-bg-hover", r && "cursor-pointer"),
				onClick: r ? () => r(e) : void 0,
				children: t.map((t) => /* @__PURE__ */ p("td", {
					className: L("text-text-primary px-3 whitespace-nowrap", t.cellClassName),
...
function pn({ type: e, title: t, children: n, dismissible: r, className: i }) {
	...
	let s = fn[e], c = s.icon;
	return /* @__PURE__ */ m("div", {
		className: L("flex gap-2.5 rounded-md border p-3", s.bg, s.border, i),
		children: [
			/* @__PURE__ */ p(c, { className: L("mt-0.5 h-4 w-4 shrink-0", s.iconColor) }),
			/* @__PURE__ */ m("div", {
				className: "min-w-0 flex-1",
...
function mn({ title: e, subtitle: t, icon: n, children: r, footer: i, className: a }) {
	return /* @__PURE__ */ p("div", {
		className: L("relative z-10 w-full max-w-sm", a),
		children: /* @__PURE__ */ m("div", {
...
function hn({ name: e, meta: t, nameAppend: n, size: r = "sm", className: i }) {
	return /* @__PURE__ */ m("div", {
		className: L("flex items-center gap-2", i),
		children: [/* @__PURE__ */ p(K, {
			name: e,
			size: "sm"
		}), /* @__PURE__ */ m("div", { children: [/* @__PURE__ */ m("p", {
			className: L("text-text-primary font-label font-medium", r === "md" ? "text-xs" : "text-2xs"),
			children: [e, n]
		}), t && /* @__PURE__ */ p("p", {
...
function vn({ color: e = "gray", dot: t, children: n, className: r }) {
	return /* @__PURE__ */ m("span", {
		className: L("font-label text-2xs inline-flex items-center gap-1.5 rounded-md px-2 py-0.5 font-medium", gn[e], r),
		children: [t && /* @__PURE__ */ p("span", { className: L("h-1.5 w-1.5 rounded-full", _n[e]) }), n]
	});
}
//#endregion
		...
		children: [/* @__PURE__ */ m("div", {
			...
			children: [yn.map((e) => /* @__PURE__ */ p("div", {
				...
				return /* @__PURE__ */ p("button", {
					...
					onMouseEnter: () => c?.(d),
					onMouseLeave: () => c?.(null),
					className: L("flex h-8 w-full cursor-pointer items-center justify-center text-xs transition-colors duration-[100ms]", "rounded-md", b && "cursor-not-allowed opacity-30", !b && !h && !g && !v && !y && "hover:bg-bg-hover text-text-primary", m && !h && !g && !v && "text-accent font-semibold", (h || g || v) && "bg-accent text-text-on-accent font-semibold", y && !h && !g && !v && "bg-accent-muted text-accent"),
					children: s
				}, s);
			})]
		})]
...
function En({ children: e, className: t, header: n, footer: r }) {
	return /* @__PURE__ */ m("div", {
		className: L("bg-bg-secondary border-border overflow-hidden rounded-md border", t),
		children: [
			n && /* @__PURE__ */ p("div", {
		...
		children: [a && /* @__PURE__ */ p("span", {
			...
			children: [
				/* @__PURE__ */ p("button", {
					type: "button",
					onClick: () => c ? l(!1) : D(),
					className: L("font-control flex h-7 w-full cursor-pointer items-center rounded-md px-2 pr-7 text-xs", "bg-bg-secondary border-border text-text-primary border", "hover:bg-bg-hover hover:border-border-strong", "transition-colors duration-[100ms]", "focus-visible:outline-accent focus-visible:outline-2 focus-visible:outline-offset-2"),
					children: x ? x.label : /* @__PURE__ */ p("span", {
						className: "text-text-disabled",
						children: r
					})
				}),
				/* @__PURE__ */ p(w, { className: L("text-text-tertiary pointer-events-none absolute top-1/2 right-2.5 h-3.5 w-3.5 -translate-y-1/2 transition-transform", c && "rotate-180") }),
				c && /* @__PURE__ */ m("div", {
					...
					children: [/* @__PURE__ */ p("div", {
						...
						children: /* @__PURE__ */ m("div", {
							className: "relative",
							children: [/* @__PURE__ */ p(N, { className: "text-text-tertiary absolute top-1/2 left-2 h-3 w-3 -translate-y-1/2" }), /* @__PURE__ */ p("input", {
								ref: y,
								type: "text",
						...
						children: C.length === 0 ? /* @__PURE__ */ p("li", {
							...
							onMouseEnter: () => _(r),
							className: L("font-control flex h-7 w-full cursor-pointer items-center gap-2 px-3 text-xs", "transition-colors duration-[100ms]", r === g ? "bg-accent-muted text-accent" : e.value === t ? "text-accent" : "text-text-secondary hover:text-text-primary hover:bg-bg-hover"),
							children: [/* @__PURE__ */ p("span", {
								className: "flex-1 truncate",
								children: e.label
							}), e.value === t && /* @__PURE__ */ p(S, { className: "h-3 w-3 shrink-0" })]
...
function On({ title: e = "Danger Zone", description: t, children: n, className: r }) {
	return /* @__PURE__ */ m("div", {
		className: L("border-border mt-8 border-t pt-6", r),
		children: [
			/* @__PURE__ */ p("h3", {
		...
		children: [e && /* @__PURE__ */ p("span", {
			...
			children: [
				/* @__PURE__ */ p("button", {
					...
					"aria-haspopup": "dialog",
					"aria-expanded": o,
					className: L("flex h-7 w-full cursor-pointer items-center rounded-md text-xs", "bg-bg-secondary border-border text-text-primary border", "hover:bg-bg-hover hover:border-border-strong", "transition-colors duration-[100ms]", "px-2 pr-7"),
				...
				o && /* @__PURE__ */ p("div", {
					...
					className: L("bg-bg-tertiary border-border-strong animate-scale-in absolute left-0 z-[100] rounded-md border p-3 shadow-lg", f ? "bottom-full mb-1" : "top-full mt-1"),
					children: /* @__PURE__ */ p(Tn, {
						year: g,
						month: v,
						selected: t,
		...
		children: [e && /* @__PURE__ */ p("span", {
			...
			children: [
				...
				a && /* @__PURE__ */ m("div", {
					...
					className: L("bg-bg-tertiary border-border-strong animate-scale-in absolute left-0 z-[100] rounded-md border p-3 shadow-lg", l ? "bottom-full mb-1" : "top-full mt-1"),
					children: [/* @__PURE__ */ m("div", {
						className: "mb-2 flex items-center justify-between",
						children: [
							/* @__PURE__ */ p("button", {
						...
						children: [
							...
							/* @__PURE__ */ m("div", {
								...
								children: [/* @__PURE__ */ p("button", {
									...
									onClick: () => E("AM"),
									"aria-pressed": T === "AM",
									className: L("text-2xs cursor-pointer px-2 py-0.5 font-medium transition-colors duration-[100ms]", T === "AM" ? "bg-accent text-text-on-accent" : "bg-bg-secondary text-text-secondary hover:bg-bg-hover"),
									children: "AM"
								}), /* @__PURE__ */ p("button", {
									type: "button",
									onClick: () => E("PM"),
									"aria-pressed": T === "PM",
									className: L("text-2xs cursor-pointer px-2 py-0.5 font-medium transition-colors duration-[100ms]", T === "PM" ? "bg-accent text-text-on-accent" : "bg-bg-secondary text-text-secondary hover:bg-bg-hover"),
									children: "PM"
								})]
							}),
							/* @__PURE__ */ p("button", {
								...
								onClick: ee,
								disabled: !D,
								className: L("ml-auto h-6 rounded-md px-3 text-xs font-medium transition-colors duration-[100ms]", D ? "bg-accent text-text-on-accent hover:bg-accent-hover cursor-pointer" : "bg-bg-hover text-text-disabled cursor-not-allowed"),
								children: "Apply"
							})
						]
					})]
...
function Wn({ open: e, onClose: t, title: n, children: r, className: a, resizable: s = !0, defaultWidth: c = Vn, minWidth: l = Hn, maxWidth: f = Un }) {
	...
	return /* @__PURE__ */ p("div", {
		className: L("border-border bg-bg-secondary relative shrink-0 overflow-hidden border-l", "transition-[width] duration-[200ms] ease-out", a),
		style: { width: e ? h : 0 },
			...
			children: [
				...
				/* @__PURE__ */ m("div", {
					...
					children: [/* @__PURE__ */ p("h3", {
						...
						children: /* @__PURE__ */ p(P, { className: "h-3.5 w-3.5" })
					})]
				}),
				/* @__PURE__ */ p("div", {
...
function Gn({ open: e, onClose: t, title: n, children: r, footer: i, className: a }) {
	...
	return B(c, e), o(() => {
		...
		children: [/* @__PURE__ */ p("div", {
			...
			ref: c,
			className: L("relative z-50 mx-4 mb-8 w-full max-w-[400px] p-6", "bg-bg-secondary border-border rounded-lg border", "animate-scale-in shadow-lg", a),
			role: "dialog",
			"aria-modal": "true",
...
function Kn({ onCancel: e, onConfirm: t, cancelLabel: n = "Cancel", confirmLabel: r = "Confirm", confirmVariant: i = "primary", className: a }) {
	return /* @__PURE__ */ m("div", {
		className: L("flex justify-end gap-2", a),
		children: [/* @__PURE__ */ p(q, {
			variant: "ghost",
			size: "sm",
			onClick: e,
	...
	return /* @__PURE__ */ m(f, { children: [/* @__PURE__ */ p("div", {
		...
		children: t.map((e, t) => {
			...
			return /* @__PURE__ */ m("button", {
				...
				onMouseEnter: () => g(n),
				className: L("flex h-7 w-full cursor-pointer items-center gap-2 px-4 text-left text-xs", "transition-colors duration-[100ms]", "focus:outline-none", e.danger ? "text-red hover:bg-red-muted focus:bg-red-muted" : "text-text-secondary hover:text-text-primary hover:bg-bg-hover focus:text-text-primary focus:bg-bg-hover"),
				children: [
...
function Yn({ icon: e, title: t, description: n, action: r, className: i }) {
	return /* @__PURE__ */ m("div", {
		className: L("flex flex-col items-center justify-center px-4 py-12", i),
		children: [
			/* @__PURE__ */ p("div", {
...
function Qn({ children: e, className: t }) {
	return /* @__PURE__ */ p("kbd", {
		className: L("text-2xs inline-flex items-center px-1.5 py-0.5 font-mono font-medium", "bg-bg-tertiary text-text-secondary border-border rounded border", t),
		children: e
	});
}
//#endregion
...
function er({ className: e, size: t = "md" }) {
	return /* @__PURE__ */ p("div", {
		className: L("flex min-h-[200px] items-center justify-center", e),
		children: /* @__PURE__ */ p(ne, { className: L("text-accent animate-spin", $n[t]) })
	});
}
//#endregion
...
function tr({ items: e, labelWidth: n = "100px", className: r }) {
	return /* @__PURE__ */ p("div", {
		className: L("gap-x-3 gap-y-2 text-xs", r),
		style: {
			display: "grid",
...
function nr({ label: e, value: t, sub: n, bar: r, icon: i, iconColor: a, className: o }) {
	return /* @__PURE__ */ m("div", {
		className: L("bg-bg-secondary border-border relative overflow-hidden rounded-md border p-3", o),
		children: [
			i && /* @__PURE__ */ p(i, { className: L("absolute -right-9 -bottom-9 h-44 w-44 -rotate-45 opacity-[0.06]", a) }),
			/* @__PURE__ */ p("p", {
...
function cr({ title: e, subtitle: t, actions: n, className: r }) {
	return /* @__PURE__ */ m("div", {
		className: L("flex items-center justify-between", r),
...
function lr({ title: e, description: t, actions: n, children: r, as: i = "h2", className: a, headerClassName: o, contentClassName: s }) {
	return /* @__PURE__ */ m("section", {
		className: L("space-y-4", a),
		children: [(e || t || n) && /* @__PURE__ */ m("div", {
			className: L("border-border flex items-end justify-between gap-3 border-b pb-2", o),
			children: [/* @__PURE__ */ m("div", {
				className: "min-w-0",
...
function dr({ page: e, pageSize: t, total: n, pageSizeOptions: r = ur, onPageChange: i, onPageSizeChange: a, className: o }) {
	...
	return /* @__PURE__ */ m("div", {
		className: L("flex items-center justify-between", o),
		children: [/* @__PURE__ */ m("div", {
	...
	return /* @__PURE__ */ m("div", {
		...
		children: [(e || t) && /* @__PURE__ */ m("div", {
			...
			children: [/* @__PURE__ */ p("input", {
				...
				className: L("bg-bg-secondary text-text-primary h-7 w-full rounded-md border px-2 pr-8 text-xs", "placeholder:text-text-disabled", "transition-colors duration-[100ms]", "focus:border-accent focus:outline-none", t ? "border-red" : "border-border", n),
				...i
			}), /* @__PURE__ */ p("button", {
				type: "button",
				onClick: () => c(!s),
...
function pr({ name: e, subtitle: t, badge: n, meta: r, action: i, className: a }) {
	return /* @__PURE__ */ m("div", {
		className: L("flex items-start gap-4", a),
		children: [
			/* @__PURE__ */ p(K, {
				name: e,
				size: "lg"
...
function hr({ options: e, value: t, onChange: n, disabled: r, className: i, "aria-label": a }) {
	return /* @__PURE__ */ p("div", {
		role: "radiogroup",
		"aria-label": a,
		className: L("border-border inline-flex overflow-hidden rounded-md border", r && "cursor-not-allowed opacity-40", i),
		children: e.map((e) => /* @__PURE__ */ p("button", {
			role: "radio",
			"aria-checked": e.value === t,
			disabled: r,
			onClick: () => n(e.value),
			className: L("font-control px-3 py-1.5 text-xs font-medium transition-colors duration-[100ms]", "focus-visible:outline-accent focus-visible:outline-2 focus-visible:outline-offset-[-2px]", !r && "cursor-pointer", e.value === t ? "bg-accent text-text-on-accent" : "bg-bg-secondary text-text-secondary hover:bg-bg-hover hover:text-text-primary"),
			children: e.label
		}, e.value))
	});
}
...
function gr({ value: e, onChange: t, placeholder: n = "Search...", className: r }) {
	return /* @__PURE__ */ m("div", {
		...
		children: [/* @__PURE__ */ p(N, { className: "text-text-tertiary absolute top-1/2 left-2 h-3.5 w-3.5 -translate-y-1/2" }), /* @__PURE__ */ p("input", {
			type: "search",
			value: e,
			onChange: (e) => t(e.target.value),
			placeholder: n,
			className: L("bg-bg-secondary text-text-primary h-7 w-full pr-2 pl-7 text-xs", "border-border rounded-md border", "placeholder:text-text-disabled", "transition-colors duration-[100ms]", "focus:border-accent focus:outline-none")
		})]
	});
}
//#endregion
	...
	return /* @__PURE__ */ m("div", {
		...
		children: [(e || t) && /* @__PURE__ */ m("div", {
			...
			children: [/* @__PURE__ */ p("select", {
				ref: o,
				id: s,
				className: L("bg-bg-secondary text-text-primary font-control h-7 w-full px-2 pr-7 text-xs", "appearance-none rounded-md border", "transition-colors duration-[100ms]", "focus:border-accent focus:outline-none", "disabled:cursor-not-allowed disabled:opacity-40", "cursor-pointer", t ? "border-red" : "border-border", r),
				...a,
...
function vr({ label: e, description: t, action: n, className: r }) {
	return /* @__PURE__ */ m("div", {
		className: L("border-border flex items-center justify-between border-b py-3", r),
		children: [/* @__PURE__ */ m("div", {
...
function yr({ open: e, onClose: t, title: n, children: r, footer: i, side: a = "right", widthClassName: s = "w-[360px]", className: c, contentClassName: l }) {
	...
	return B(d, e), o(() => {
		...
		children: [
			...
			/* @__PURE__ */ m("div", {
				ref: d,
				className: L("bg-bg-secondary border-border flex flex-col shadow-lg", s, a === "right" ? "animate-slide-in-right border-l" : "animate-slide-in-left border-r", c),
				...
				children: [
					...
					/* @__PURE__ */ p("div", {
						className: L("flex-1 overflow-y-auto p-3", l),
						children: r
					}),
					i && /* @__PURE__ */ p("div", {
...
function br({ children: e, direction: t = "row", className: n }) {
	return /* @__PURE__ */ p("div", {
		className: L("-m-4 md:-m-6", "flex h-[calc(100vh-var(--topbar-height)-var(--bottomnav-height))] gap-0 md:h-[calc(100vh-var(--topbar-height))]", t === "column" && "flex-col", n),
		children: e
	});
}
function xr({ children: e, className: t }) {
	return /* @__PURE__ */ p("div", {
		className: L("flex min-h-0 min-w-0 flex-1 flex-col overflow-hidden", t),
		children: e
	});
}
...
function Tr({ status: e, label: t, className: n }) {
	return /* @__PURE__ */ m("span", {
		className: L("inline-flex items-center gap-1.5", n),
		children: [/* @__PURE__ */ p("span", { className: L("h-2 w-2 rounded-full", Cr[e]) }), t && /* @__PURE__ */ p("span", {
			className: L("text-xs", wr[e]),
			children: t
		})]
	});
}
...
function Er({ steps: e, currentStep: t, className: n }) {
	return /* @__PURE__ */ p("div", {
		className: L("flex items-center justify-between", n),
		children: e.map((n, r) => /* @__PURE__ */ m("div", {
			...
			children: [/* @__PURE__ */ m("div", {
				...
				children: [
					/* @__PURE__ */ p("div", {
						className: L("flex h-8 w-8 items-center justify-center rounded-full text-xs", r < t && "bg-accent text-text-on-accent", r === t && "border-accent text-accent border-2 font-semibold", r > t && "bg-bg-tertiary border-border text-text-tertiary border"),
						children: r < t ? /* @__PURE__ */ p(S, { className: "h-4 w-4" }) : r + 1
					}),
					/* @__PURE__ */ p("span", {
						className: L("text-2xs mt-1.5 hidden sm:block", r === t && "text-accent", r < t && "text-text-primary", r > t && "text-text-tertiary"),
						children: n.label
					}),
			...
			}), r < e.length - 1 && /* @__PURE__ */ p("div", { className: L("mx-2 h-0.5 flex-1", r < t ? "bg-accent" : "bg-border") })]
		}, n.label))
	});
}
//#endregion
	...
	return /* @__PURE__ */ m("div", {
		...
		children: [/* @__PURE__ */ p("div", {
			...
			children: e.map((e) => /* @__PURE__ */ m("button", {
				...
				onClick: () => f(e.key),
				onKeyDown: _,
				className: L("font-control relative cursor-pointer px-3 py-2 text-xs font-medium transition-colors duration-[100ms]", "hover:text-text-primary", e.key === c ? "text-accent" : "text-text-tertiary"),
	...
	return /* @__PURE__ */ m("div", {
		...
		children: [
			...
			/* @__PURE__ */ p("textarea", {
				...
				value: i,
				maxLength: r,
				className: L("bg-bg-secondary text-text-primary font-control min-h-[72px] w-full px-2 py-1.5 text-xs", "resize-y rounded-md border", "placeholder:text-text-disabled", "transition-colors duration-[100ms]", "focus:border-accent focus:outline-none", t ? "border-red" : "border-border", a),
				...s
			}),
			/* @__PURE__ */ m("div", {
	...
	return /* @__PURE__ */ m("div", {
		...
		children: [(e || t) && /* @__PURE__ */ m("div", {
			...
			children: [n && /* @__PURE__ */ p("span", {
				...
				id: c,
				readOnly: a,
				className: L("bg-bg-secondary text-text-primary font-control h-7 w-full px-2 text-xs", "rounded-md border", "placeholder:text-text-disabled", "transition-colors duration-[100ms]", "focus:border-accent focus:outline-none", "disabled:cursor-not-allowed disabled:opacity-40", a && "bg-bg-primary text-text-secondary focus:border-border cursor-default border-dashed", n && "pl-7", t ? "border-red" : !a && "border-border", a && !t && "border-border", r),
				...o
			})]
		})]
	});
...
function Ar({ items: e, className: t }) {
	return /* @__PURE__ */ p("div", {
		className: L("space-y-0", t),
		children: e.map((t, n) => /* @__PURE__ */ m("div", {
			className: "flex gap-3",
			children: [/* @__PURE__ */ m("div", {
				className: "flex flex-col items-center",
				children: [/* @__PURE__ */ p("div", { className: L(t.dot, "mt-1.5 h-2 w-2 shrink-0 rounded-full") }), n < e.length - 1 && /* @__PURE__ */ p("div", { className: "bg-border mt-1 w-px flex-1" })]
			}), /* @__PURE__ */ m("div", {
				className: L("pb-4", n === e.length - 1 && "pb-0"),
				children: [/* @__PURE__ */ p("p", {
					className: "text-text-primary text-xs",
					children: t.text
				}), /* @__PURE__ */ p("p", {
...
function Mr({ content: e, placement: t = "top", children: n }) {
	...
	return /* @__PURE__ */ m("div", {
		...
		children: [n, r && /* @__PURE__ */ p("div", {
			id: a,
			className: L("text-2xs absolute z-50 px-2 py-1 font-medium whitespace-nowrap", "bg-bg-tertiary text-text-primary border-border rounded border shadow-md", "animate-fade-in pointer-events-none", jr[t]),
			role: "tooltip",
			children: e
		})]
	});
...
function Nr({ start: e, end: t, children: n, className: r, startClassName: i, endClassName: a }) {
	return /* @__PURE__ */ m("div", {
		className: L("flex items-center justify-between gap-3", r),
		children: [/* @__PURE__ */ p("div", {
			className: L("flex flex-1 items-center gap-3", i),
			children: e ?? n
		}), t && /* @__PURE__ */ p("div", {
			className: L("flex items-center gap-1.5", a),
			children: t
		})]
	});
}
...
function Pr({ title: e = "Drag and drop files here, or click to browse", description: t, icon: n, accept: r, multiple: i, disabled: a, onChange: o, className: s }) {
	return /* @__PURE__ */ m("label", {
		className: L("border-border hover:border-border-strong block rounded-md border-2 border-dashed p-8 text-center transition-colors duration-[100ms]", a ? "cursor-not-allowed opacity-60" : "cursor-pointer hover:bg-bg-hover", s),
		children: [
			/* @__PURE__ */ p("input", {
				type: "file",
				accept: r,
			...
			/* @__PURE__ */ p("div", {
				...
				children: n ?? /* @__PURE__ */ p(de, { className: "h-4.5 w-4.5" })
			}),
			/* @__PURE__ */ p("p", {
...
}, Hr = "leonardaustin-ui-settings", Ur = new Set(Object.keys(Vr)), Wr = new Set(Object.keys(H)), Q = new Set(Object.keys(Z)), Gr = new Set([
	"light",
	"dark",
	"system"
]);
...
function Zr({ children: e, storageKey: t = Hr }) {
	...
	let h = l(() => Yr(c, n.themeOverrides), [c, n.themeOverrides]), g = c in n.themeOverrides, _ = !Xr(u, h), v = i(() => {
		...
		delete e[c], m({ themeOverrides: e }), f(H[c] ?? H.dark);
	}, [
		m,
		n.themeOverrides,
		c
...
//#endregion
export { pn as Alert, nn as AppShell, he as AreaChart, mn as AuthCard, rn as AuthLayout, hn as AuthorByline, K as Avatar, an as BackLink, vn as Badge, _e as BarChart, $e as BottomNav, Lt as Breadcrumbs, q as Button, tt as COMMAND_PALETTE_EVENT, Tn as CalendarGrid, En as Card, on as Checkbox, cn as ColumnPicker, Dn as Combobox, ot as CommandPalette, nt as DEFAULT_COMMAND_PALETTE_SHORTCUT, On as DangerZone, An as DatePicker, Pn as DateRangePicker, Bn as DateTimePicker, Wn as DetailPanel, Gn as Dialog, Kn as DialogActions, qn as DividerLabel, He as DonutChart, Jn as DropdownMenu, Yn as EmptyState, Xn as ErrorBoundary, sn as FilterButton, Zn as FilterDropdown, Qn as Kbd, er as LoadingSpinner, tr as MetadataGrid, nr as MetricCard, ct as MobileDrawer, sr as OAuthButton, cr as PageHeader, lr as PageSection, ln as Pagination, dr as PaginationBar, fr as PasswordInput, pr as ProfileHeader, mr as ProseContent, We as RadarChart, Ke as RadialBarChart, hr as RadioPill, dn as ResourceTable, gr as SearchInput, J as SectionHeader, _r as Select, Y as SelectDropdown, vr as SettingRow, gt as SettingsContext, Zr as SettingsProvider, yr as SideSheet, Ft as Sidebar, X as Slider, qe as SparkLine, Sr as SplitPaneLayout, Tr as StatusDot, Er as StepProgress, Jt as THEME_MENU_EVENT, Dr as Tabs, kr as TextInput, Or as Textarea, Fr as ThemeContext, Zt as ThemeMenu, Kt as ThemePreview, $r as ThemeProvider, Ar as Timeline, St as ToastProvider, qt as Toggle, Nr as Toolbar, Mr as Tooltip, tn as TopBar, Pr as UploadDropzone, Xe as VerticalBarChart, ht as accentItems, L as cn, ft as darkThemes, U as fontOptions, zr as formatDateLong, Rr as formatDateShort, Br as formatRelative, z as handleAppShellNavigate, Ze as isAppShellPathActive, V as isLightTheme, dt as lightThemes, it as matchesCommandPaletteShortcut, Qe as navigateToPath, rt as openCommandPalette, Yt as openThemeMenu, un as sortRows, H as themeDefaults, lt as themeItems, Rt as useApplyTheme, W as useDismiss, B as useFocusTrap, G as useSettings, Ir as useTheme, xt as useToast };
